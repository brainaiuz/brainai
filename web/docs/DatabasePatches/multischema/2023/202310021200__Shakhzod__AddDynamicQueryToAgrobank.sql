delete
from dynamic_query
where query_name = 'UPDATE_POSITION_FIELDS_311555';
...
BEGIN
-- Retrieve the overallstatus value
SELECT overallstatus INTO v_status FROM "311555".custom_form_item WHERE form_id = ''TARIFNAJA_SETKA_FORM'' AND id = (SELECT v_id FROM temp_v_names);

-- Check the value and execute subsequent queries if it''s approved
IF v_status = 1445 THEN
-- UPDATE "311555".position ...
-- Set coefficient based on your logic
