update "0".modelfield set fsection = 'BASIC_INFORMATION' , hide = true where form_id = 'POSITION_FORM' and field_id = 'COEFFICENT';
...
update "anv".modelfield set fsection = 'BASIC_INFORMATION' , hide = true where form_id = 'POSITION_FORM' and field_id = 'COEFFICENT';
