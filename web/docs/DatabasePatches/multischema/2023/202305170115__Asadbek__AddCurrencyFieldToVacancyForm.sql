...
delete from "anv".modelfield where form_id = 'VACANCY_FORM' and field_id = 'CURRENCY';
insert into "anv".modelfield (form_id, field_id, mandatory, hide, columntype, fsection, forder) values('VACANCY_FORM', 'CURRENCY', false , false, 'COL_3', 'VACANCY_BASIC_INFORMATION', 8);
