...
values ('WHITE_LABEL_FORM', 'PHONE_NUMBER', false, false, 'COL_1', 'BASIC_INFORMATION', 4);

insert into "anv".modelfield (form_id, field_id, mandatory, hide, columntype, fsection, forder)
values ('WHITE_LABEL_FORM', 'SCHEDULE_DEMO_URL', false, false, 'COL_1', 'BASIC_INFORMATION', 5);

insert into "anv".modelfield (form_id, field_id, mandatory, hide, columntype, fsection, forder)
values ('WHITE_LABEL_FORM', 'SHOW_SCHEDULE_DEMO', false, false, 'COL_1', 'BASIC_INFORMATION', 6);

insert into "anv".modelfield (form_id, field_id, mandatory, hide, columntype, fsection, forder)
values ('WHITE_LABEL_FORM', 'SHOW_PHONE_NUMBER', false, false, 'COL_1', 'BASIC_INFORMATION', 7);
