...
values ('POSITION_FORM', 'MEASURING_EMPLOYEE_PERFORMANCE', false, 'COL_1', 'KNOWLEDE_AND_SKILLS', 1, false);

insert into "anv".modelfield (form_id, field_id, mandatory, columntype, fsection, forder, hide)
values ('POSITION_FORM', 'KNOWLEDGE', false, 'COL_2', 'KNOWLEDE_AND_SKILLS', 1, false);

insert into "anv".modelfield (form_id, field_id, mandatory, columntype, fsection, forder, hide)
values ('POSITION_FORM', 'PERSONAL_QUALITIES', false, 'COL_3', 'KNOWLEDE_AND_SKILLS', 1, false);

-- white lable fields

insert into "anv".modelfield (form_id, field_id, mandatory, hide, columntype, fsection, forder)
values ('WHITE_LABEL_FORM', 'OPENAI', false, false, 'COL_1', 'BASIC_INFORMATION', 2);
