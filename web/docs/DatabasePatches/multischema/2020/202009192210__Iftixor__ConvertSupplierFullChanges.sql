delete  from "anv".form_property where form_id ='SUPPLIER_FORM';
insert into "anv".form_property (form_id, settingsjsondata)
values ('SUPPLIER_FORM',
        '[
  {
    "code": "CRM_NOTE",
    "title": "Notes",
