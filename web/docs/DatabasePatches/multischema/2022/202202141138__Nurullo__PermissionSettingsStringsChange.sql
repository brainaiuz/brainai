...
set sorder= 4,
    parent=(select id from permission where code = 'SETTINGS_INTEGRATION'),
    name='Fingerprint'
where code = 'HRMS_FINGERPRINT';

/* Children*/
update permission
set sorder= 1,
    parent=(select id from permission where code = 'HRMS_FINGERPRINT'),
    name='Add Fingerprint'
where code = 'HRMS_ADD_FINGERPRINT';
