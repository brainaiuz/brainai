...
insert into "anv".modelfield (form_id, field_id, mandatory, hide, columntype, fsection, forder) values('VACANCY_FORM', 'vacancyPlaceCount', false, false, 'COL_3', 'VACANCY_BASIC_INFORMATION', 1);
insert into "anv".modelfield (form_id, field_id, mandatory, hide, columntype, fsection, forder) values('VACANCY_FORM', 'gender', false, false, 'COL_3', 'VACANCY_BASIC_INFORMATION', 2);
insert into "anv".modelfield (form_id, field_id, mandatory, hide, columntype, fsection, forder) values('VACANCY_FORM', 'vacancyRequiredDegree', false, false, 'COL_3', 'VACANCY_BASIC_INFORMATION', 3);
insert into "anv".modelfield (form_id, field_id, mandatory, hide, columntype, fsection, forder) values('VACANCY_FORM', 'vacancyJobType', false, false, 'COL_3', 'VACANCY_BASIC_INFORMATION', 4);
