delete  from "anv".customlayout_new_ui where formid='WHITE_LABEL_FORM';
INSERT INTO "anv".customlayout_new_ui ( active, addform, customcss, editform, formid, importform, layout, title, validations, viewform, webform) VALUES ( true, true, null, true, 'WHITE_LABEL_FORM', false, e'<div class="contentBar" style="padding:0 10px;margin-top:2px;">
...
</div>', 'Custom Form Add/Edit', null, false, false);
