...
values ('TRANSFER_MONEY_VIEW', 'INFORMATION', 'INFORMATION', '', 'field', 'COL_1', false, 'LOOKUP', 1, 'FROM_ACCOUNT_LOOKUP'),
       ...
       ('TRANSFER_MONEY_VIEW', 'INFORMATION', 'INFORMATION', '', 'field', 'COL_1', false, 'TextBox', 4, 'TRANSFER_MONEY_AMOUNT_CURRENCY'),
       ('TRANSFER_MONEY_VIEW', 'INFORMATION', 'INFORMATION', '', 'field', 'COL_1', false, 'DataListBox', 5, 'TRANSFER_MONEY_AMOUNT'),
