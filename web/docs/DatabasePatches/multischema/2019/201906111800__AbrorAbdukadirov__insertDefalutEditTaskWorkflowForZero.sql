...
BEGIN
  insert into "0".workflowrule (name, executioncriteria, module, active) values ('Default Task edit', '_WORKFLOW_EXECUTION_CRITERIA_EDIT', '_WORKFLOW_MODULE_TASK', false)  returning id into workflowID;
  ...
  VALUES (FALSE, NULL, '${assignments_emails}', NULL, 'Update Task', '', '', NULL, workflowID, 0, 'TRIGGER_TIME', 'MINUTES', FALSE,
