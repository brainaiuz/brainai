delete from "0".property where objectName = 'saleinvoice';
insert into "0".property (objectName, defaultName, singular, plural, shortcut, moduleCode, isactive)
values ('saleinvoice', 'Sales Invoice', 'Sales Invoice', 'Sales Invoices', 'SI', 'accounting', false);

delete from "0_template".property where objectName = 'saleinvoice';
insert into "0_template".property (objectName, defaultName, singular, plural, shortcut, moduleCode, isactive)
values ('saleinvoice', 'Sales Invoice', 'Sales Invoice', 'Sales Invoices', 'SI', 'accounting', false);

delete from "anv".property where objectName = 'saleinvoice';
