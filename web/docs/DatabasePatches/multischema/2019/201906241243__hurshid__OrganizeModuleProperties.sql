delete from "0".property where objectName = 'salequote';
insert into "0".property (objectName, defaultName, singular, plural, shortcut, moduleCode, isactive)
values ('salequote', 'Sales Quote', 'Sales Quote', 'Sales Quotes', 'SQ', 'accounting', false);

delete from "0_template".property where objectName = 'salequote';
insert into "0_template".property (objectName, defaultName, singular, plural, shortcut, moduleCode, isactive)
values ('salequote', 'Sales Quote', 'Sales Quote', 'Sales Quotes', 'SQ', 'accounting', false);

delete from "anv".property where objectName = 'salequote';
