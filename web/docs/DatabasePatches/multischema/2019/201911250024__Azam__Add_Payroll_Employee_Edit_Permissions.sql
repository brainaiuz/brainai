...
insert into "0".rolepermission (permissioncode, rolecode,access) values('PAYROLL_EMPLOYEE_EDIT','HR','ALLOW');
insert into "0".rolepermission (permissioncode, rolecode,access) values('PAYROLL_EMPLOYEE_EDIT','PM','ALLOW');
...
insert into "anv".rolepermission (permissioncode, rolecode,access) values('PAYROLL_EMPLOYEE_EDIT','HR','ALLOW');
insert into "anv".rolepermission (permissioncode, rolecode,access) values('PAYROLL_EMPLOYEE_EDIT','PM','ALLOW');
