delete from "0".property where objectName = 'contacts';
insert into "0".property (objectName, defaultName, singular, plural, shortcut, moduleCode, isactive)
values ('contacts', 'Contacts', 'Contact', 'Contacts', 'C', 'crm', false);


delete from "0_template".property where objectName = 'contacts';
insert into "0_template".property (objectName, defaultName, singular, plural, shortcut, moduleCode, isactive)
values ('contacts', 'Contacts', 'Contact', 'Contacts', 'C', 'crm', false);


delete from "anv".property where objectName = 'contacts';
