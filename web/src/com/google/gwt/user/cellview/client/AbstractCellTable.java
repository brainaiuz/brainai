...
public abstract class AbstractCellTable<T> extends AbstractHasData<T> {
        ...
        public final void replaceChildren(AbstractCellTable<?> table, TableSectionElement section,
            ...
            if (table.legacyRenderRowValues) {
                ...
                while (insertBefore != null && count < childCount) {
                    ...
                    insertBefore = (next == null) ? null : next.cast();
                    count++;
                }
            } else {
    ...
    private boolean isCustomHeaderStyle;
    ...
    private final Map<Integer, String> columnWidthsByIndex = new HashMap<>();
	...
	public boolean isCustomHeaderStyle() {
		return isCustomHeaderStyle;
	}

	public void setCustomHeaderStyle(boolean customHeaderStyle) {
		isCustomHeaderStyle = customHeaderStyle;
	}
    ...
    protected final void renderRowValuesLegacy(SafeHtmlBuilder sb, List<T> values, int start,
        ...
        for (int i = start; i < end; i++) {
            ...
            boolean isSelected =
                    (selectionModel != null && value != null) && selectionModel.isSelected(value);
     ...
     */
        if (html == null || !legacyRenderRowValues) {
    ...
    protected void setKeyboardSelected(int index, boolean selected, boolean stealFocus) {
        ...
        for (int i = 0; i < cells.getLength(); i++) {
            ...
            if (selected && stealFocus && !cellIsEditing && isKeyboardSelected) {
                CellBasedWidgetImpl.get().resetFocus(() -> focusable.focus());
            }
        }
    }
    ...
    private <C> void fireEventToCell(Event event, String eventType, Element parentElem,
       ...
       */
            ...
            ValueUpdater<C> valueUpdater = (fieldUpdater == null) ? null : value -> fieldUpdater.update(index, rowValue, value);
        ...
        if (cellWasEditing && !cellIsEditing) {
            CellBasedWidgetImpl.get().resetFocus(() -> setFocus(true));
        }
    }
