...
public class ListBox extends FocusWidget implements SourcesChangeEvents,
  ...
  public void addItem(String item, String value, String itemClassName) {
    insertItem(item, null, value, INSERT_AT_END, itemClassName);
  }
  ...
  public void insertItem(String item, Direction dir, String value, int index) {
    insertItem(item, dir, value, INSERT_AT_END, null);
  }
  public void insertItem(String item, Direction dir, String value, int index, String className) {
