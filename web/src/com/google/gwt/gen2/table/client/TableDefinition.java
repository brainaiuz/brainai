...
public interface TableDefinition<RowType> {
     ...
     * @param <RowType> the type of the row values
     */
    abstract class AbstractCellView<RowType> {
         ...
         * Set the {@link Widget} in the current cell.
         *
         * @param color the widget to set
         */
        public abstract void setRowColor(String color);
     ...
     * @param <RowType> the type of the row values
     */
    abstract class AbstractRowView<RowType> {
        private int rowIndex = 0;
