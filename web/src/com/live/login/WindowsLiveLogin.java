...
//        setAppId("000000004001B438");
//        setSecret("iGTvvezHMqIzYGLZEjAHnEvkthgipBze");
//        setPolicyUrl("http://aws.workforcetrack.com/delauth/policy.html");
//        setReturnUrl("http://localhost:8080/liveidauth");
//        setSecurityAlgorithm("wsignin1.0");
    }
    ...
    public ConsentToken processConsent(Map<String, String[]> query) {
        ...
        String responseCode = "RequestApproved";
    ...
    public String decodeToken(String token, byte[] cryptKey) {
        ...
        try {
            ...
            byte[] iv = copyOf(tokenBytes, ivLen);
            byte[] crypted = copyOfRange(tokenBytes, ivLen,
                    tokenBytes.length);
