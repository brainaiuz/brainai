...
public class AbsolutePositionDropController extends AbstractPositioningDropController {
    ...
    protected final ArrayList<Draggable> draggableList = new ArrayList<>();
    ...
    public void onMove(DragContext context) {
        ...
        for (Draggable draggable : draggableList) {
            ...
            if (draggable.positioner.getOffsetHeight() > 400) {
                draggable.positioner.setHeight("360px");
            }
