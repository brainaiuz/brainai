...
public class RecurringDeductionSummaryView extends CustomForm2 implements Colapse {
    ...
    public RecurringDeductionSummaryView(Integer objectId) {
        super("summary");
    ...
    protected void save(String status) {
        ...
        PayrollService.App.get().saveRecurringPaymentDeduction(transferObject, new AsyncCallback<TestRPC>() {
            ...
            public void onSuccess(TestRPC result) {
                LoadingPanel.loading(false);
                WfmUiEventsBus.fireWfmUiEvent(WfmUiEventType.ON_PAYROLL_RECURRING_PD_ADD, result, RecurringDeductionSummaryView.this);
                closeTab();
            }
        });
    }
    ...
    private void initTerms() {
        ...
        termsMap.put(2, wfmStrings.ofBasicAllowances());
