 ...
 * </p>
 */
public class ModifiedPopupPanel extends PopupPanel implements SourcesPopupEvents,
        EventPreview {

    /**
     * A callback that is used to set the position of a {@link ModifiedPopupPanel} right
     * before it is shown.
     */
    public interface PositionCallback {
         ...
         * @see ModifiedPopupPanel#setPopupPositionAndShow(PositionCallback)
         */
     ...
     */
    public ModifiedPopupPanel(boolean autoHide) {
        this();
     ...
     */
    public ModifiedPopupPanel(boolean autoHide, boolean modal) {
        this(autoHide);
        this.modal = modal;
    }
    ...
    public int getPopupLeft() {
        try {
            ...
            Window.alert("Error was found! Element offsetLeft parameter is null... ");
            return 0;
        }
    }
    ...
    public boolean onEventPreview(Event event) {
        ...
        switch (type) {
            ...
            case Event.ONDBLCLICK: {
                // Don't eat events if events capture is enabled, as this can interfere
                ...
                // hide the popup and _don't_ eat the events. ONMOUSEDOWN is used to
     ...
     */
    public void setPopupPosition(int left, int top, boolean b) {
        ...
        topPosition = top;
        if (!b) {
            if (Window.getClientHeight() - top < 200) {
                topPosition = Window.getClientHeight() - 200;
            }
        }
    ...
    public void show() {
        ...
        DOM.setIntStyleAttribute(getElement(), "zIndex", 10000);
    ...
    protected Element getContainerElement() {
        return impl.getContainerElement(getElement()).cast();
    }
