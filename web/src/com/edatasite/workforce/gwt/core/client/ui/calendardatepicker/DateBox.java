...
/**
 * A text box that shows a {@link com.edatasite.workforce.gwt.core.client.ui.calendardatepicker.DatePicker} when the user focuses on it.
 *
 ...
 * {@link com.edatasite.workforce.gwt.core.client.ui.calendardatepicker.DateBox.DefaultFormat} when the text does not represent a date that
 * can be parsed</dd>
 * </dl>
 *
 * <p>
...
public class DateBox extends Composite implements HasValue<Date>,
  ...
  /**
   * Default {@link com.edatasite.workforce.gwt.core.client.ui.calendardatepicker.DateBox.Format} class. The date is first parsed using the
   * {@link com.google.gwt.i18n.client.DateTimeFormat} supplied by the user, or
   * {@link com.google.gwt.i18n.client.DateTimeFormat#getMediumDateFormat()} by default.
   * <p>
   ...
   * the {@link com.edatasite.workforce.gwt.core.client.ui.calendardatepicker.DateBox}. The style will be removed when either a successful
   * {@link #parse(com.edatasite.workforce.gwt.core.client.ui.calendardatepicker.DateBox,String, boolean)} is called or
   * {@link #format(com.edatasite.workforce.gwt.core.client.ui.calendardatepicker.DateBox, java.util.Date)} is called.
   * <p>
   * Use a different {@link com.edatasite.workforce.gwt.core.client.ui.calendardatepicker.DateBox.Format} instance to change that behavior.
   * </p>
   */
  public static class DefaultFormat implements Format {
     ...
     * Creates a new default format instance.
     *
     * @param dateTimeFormat the {@link com.google.gwt.i18n.client.DateTimeFormat} to use with this
     *          {@link Format}.
     */
  ...
  private class DateBoxHandler implements ValueChangeHandler<Date>,
    ...
    public void onFocus(FocusEvent event) {
      if (allowDPShow && !isDatePickerShowing()) {
        showDatePicker();
      }
    }
  ...
  private final CalendarDatePicker picker;
  ...
  public DateBox() {
    this(new CalendarDatePicker(true), null, DEFAULT_FORMAT);
  }
   ...
   */
  public DateBox(CalendarDatePicker picker, Date date, Format format) {
    this.picker = picker;
   ...
   * {@link com.edatasite.workforce.gwt.core.client.ui.calendardatepicker.DateBox}.
   *
   * @return the format
   */
   ...
   * {@link com.edatasite.workforce.gwt.core.client.ui.calendardatepicker.DateBox}. If this {@link com.edatasite.workforce.gwt.core.client.ui.calendardatepicker.DateBox} is not empty, the contents of date
  ...
  private void preventDatePickerPopup() {
    allowDPShow = false;
    DeferredCommand.addCommand((Command) () -> allowDPShow = true);
  }
