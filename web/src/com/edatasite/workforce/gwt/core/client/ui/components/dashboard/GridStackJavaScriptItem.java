 ...
 */
public class GridStackJavaScriptItem extends JavaScriptObject {

    protected GridStackJavaScriptItem() {
    }

    public static native GridStackJavaScriptItem create()/*-{
        return {};
    }-*/;
    ...
    public final native void setComponentCode(String code)/*-{
        this.componentCode = code;
    }-*/;

    public final native String getComponentCode()/*-{
