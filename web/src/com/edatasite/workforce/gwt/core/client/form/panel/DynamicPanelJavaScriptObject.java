 ...
 */
public class DynamicPanelJavaScriptObject extends JavaScriptObject {

    protected DynamicPanelJavaScriptObject() {

    }

    private static native DynamicPanelJavaScriptObject create()/*-{
      return {};
    }-*/;

    public static DynamicPanelJavaScriptObject createOptions() {
        DynamicPanelJavaScriptObject option = create();
