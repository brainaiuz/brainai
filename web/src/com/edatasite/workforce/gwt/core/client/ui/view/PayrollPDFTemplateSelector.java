...
/**
 * Created by Shohruh on 28-May-16.
 */
public class PayrollPDFTemplateSelector {
    private static final WfmStrings wfmStrings = WfmStrings.App.get();
    private KpiModal dialogBox;

    public PayrollPDFTemplateSelector(String templateType, final ExtendedCommand listener) {
        AllInOneService.App.get().getCompanyPdfTemplates(templateType, new AbstractAsyncCallback<PayrollPdfTemplateList>() {
            @Override
            ...
            @Override
            public void success(PayrollPdfTemplateList itemList) {
    ...
    private void initForm(final ExtendedCommand listener, PayrollPdfTemplateList itemList) {
