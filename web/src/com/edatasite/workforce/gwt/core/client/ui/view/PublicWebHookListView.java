 ...
 * Date : 12.03.2025
 */
public class PublicWebHookListView extends BaseListView implements Constants, Constants.WorkflowActionConstants {
    ...
    public PublicWebHookListView() {
        super("publicWebHooks", "Public Webhooks");
    }
    ...
    private ColumnDefinitionConfig[] getColumnConfigs() {
        ...
        columns[++index] = new ColumnDefinitionConfig<WorkflowWebHookListItem, Anchor>(wfmStrings.action(), LISTING_ACTION.COLUMN_CODE, LISTING_ACTION.COLUMN_WIDTH) {
            ...
            public Anchor getCellValue(final WorkflowWebHookListItem item) {
                ...
                summary.setCommand(() -> SinksContainerFactory.entryPoint.onHistoryChanged("publicwebhook|summary/" + item.getId()));
                actionItemCount++;
                menuBar.addItem(summary);

                MenuPopItem edit = new MenuPopItem(wfmStrings.edit(), "icon-edit");
                edit.setCommand(() -> SinksContainerFactory.entryPoint.onHistoryChanged("publicwebhook|add/add/" + item.getId()));
                actionItemCount++;
        ...
        columns[++index] = new ColumnDefinitionConfig<WorkflowWebHookListItem, SimpleLink>(wfmStrings.name(), "name", 100) {
            ...
            public SimpleLink getCellValue(WorkflowWebHookListItem item) {
                ...
                link.addClickHandler(clickEvent -> SinksContainerFactory.entryPoint.onHistoryChanged("publicwebhook|summary/" + item.getId()));
                return link;
            }
        };
    ...
    protected Widget onInitialize() {
        ...
        WfmUiEventsBus.addWfmUiListener(WfmUiEventType.ON_WORKFLOW_WEB_HOOK_ADD, PublicWebHookListView.this, (sender, args) -> refresh());
        WfmUiEventsBus.addWfmUiListener(WfmUiEventType.ON_WORKFLOW_WEB_HOOK_REMOVE, PublicWebHookListView.this, (sender, args) -> refresh());
        WfmUiEventsBus.addWfmUiListener(WfmUiEventType.ON_WORKFLOW_WEB_HOOK_UPDATE, PublicWebHookListView.this, (sender, args) -> refresh());
    ...
    private ListingPanelDesign getListingDesign() {
        return new ListingPanelDesign() {
            ...
            public ActionButton initTopToolBarNew() {
                ...
                addNew.addClickHandler(event -> SinksContainerFactory.entryPoint.onHistoryChanged("publicwebhook|add/add"));
                return addNew;
            }
            ...
            public void initDataEmptyTable(ListingEmptyDataInitializer emptyDataTable) {
                ...
                message.setHref("publicwebhook|add/add");
    ...
    private void loadWebHookList(ListingFilterParameter fp, ListingCallback callback, Span container) {
        ...
        AllInOneService.App.get().getPublicWebHooks(filterParameter, new AsyncCallback<ListResult<WorkflowWebHookListItem>>() {
