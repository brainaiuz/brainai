 ...
 * </p>
 */
public class CalendarDatePicker extends Composite implements
    ...
    static class StandardCss {
        ...
        static StandardCss DEFAULT = new StandardCss("gwt-DatePicker gwt-DatePicker-mod", "datePicker");
    ...
    private static class DateStyler {
        ...
        public void setStyleName(Date d, String styleName, boolean add) {
            ...
            if (add) {
                ...
                } else if (!current.contains(styleName)) {
     ...
     */
    public CalendarDatePicker(boolean showTextBox) {
        this(new DefaultMonthSelector(showTextBox), new DefaultCalendarView(),
                new CalendarModel());
    }
    ...
    protected CalendarDatePicker(MonthSelector monthSelector, CalendarView view,
                                 CalendarModel model) {
    ...
    /**
     * Returns a {@link com.google.gwt.editor.client.adapters.TakesValueEditor} backed by the DatePicker.
     */
    ...
    /**
     * Sets the {@link com.edatasite.workforce.gwt.core.client.ui.calendardatepicker.CalendarDatePicker}'s value.
     *
