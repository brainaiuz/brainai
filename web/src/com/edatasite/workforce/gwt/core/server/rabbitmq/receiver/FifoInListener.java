...
public class FifoInListener extends FifoBaseListener {
    ...
    protected void doAction(FifoItem fifoItem) {
        ...
        runOutTransactionsByFIFO(fifoItem);
    ...
    void runOutTransactionsByFIFO(FifoItem fifoItem) {
        ...
        if (availableQty.compareTo(BigDecimal.ZERO) < 0) {
            ...
            if (outItemsBefore.isEmpty()) {
                System.out.println("==============FIFO IN EXCEPTION: IndexOutOfBoundsException: Index: -1, Size: 0, Cluster: "
                        ...
                        + ", TransactionId: " + fifoItem.getTransactionId()
