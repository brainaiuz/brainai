 ...
 */
public class SalesOrderPackingSlipPDFHandler extends BaseInvoicePdfHandler {
    ...
    public <ClientOrSupplier extends EdsCrmAccount> ITextGenericPdfData getInvoiceData(NewInvoice invoice, EdsUser edsUser, EdsCurrency edsCurrency, ClientOrSupplier clientOrSupplier, EdsCrmContact clientContact) {
        ...
        numDateTableRowKeys.put(INV_NUMBER, invoice.isSalesOrder() ? pdfWfmMessageSource.localizeAccounting(PdfLocalizationName.orderNumber) : pdfWfmMessageSource.localizeAccounting(PdfLocalizationName.quoteNumber));
        ...
        numDateTableRowKeys.put(INV_DATE, pdfWfmMessageSource.localizeAccounting(PdfLocalizationName.orderDate));
        numDateTableRowKeys.put(INV_DUE_DATE, pdfWfmMessageSource.localizeAccounting(PdfLocalizationName.validUntil));
        ...
        baseInvoice.setNumberAndDatesTable(getNumberAndDatesTableData(invoice, edsUser, numDateTableRowKeys));
        ...
        baseInvoice.getProductTable().addTableWidthPercentage(0.1f, 0.5f, 1f, 0.2f);
...
//        //Consignor And Consignee
        ...
        String numberLabel = invoice.isSalesOrder()
                             ? pdfWfmMessageSource.localizeAccounting(PdfLocalizationName.orderNumber)
        ...
        String[] numAndDatesLabels = {pdfWfmMessageSource.localizeAccounting(PdfLocalizationName.reciepNumber),
                                      ...
                                      pdfWfmMessageSource.localizeAccounting(PdfLocalizationName.orderDate),
                                      pdfWfmMessageSource.localizeAccounting(PdfLocalizationName.validUntil),
        ...
        baseInvoice.setPaypallData(getPayPallLinkAndImgUrl(invoice, edsCompany.getObjectID(), true, false));
        baseInvoice.setStripeData(getStripeLinkAndImgUrl(invoice, edsCompany.getObjectID(), true, false));
    ...
    protected PdfReferenceCodeNameEnum getPdfCodeName(Object dataClass) {
        return PdfReferenceCodeNameEnum.SO_PACKING_SLIP;
    }
