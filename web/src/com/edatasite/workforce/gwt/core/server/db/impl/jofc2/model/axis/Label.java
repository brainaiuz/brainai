...
import com.edatasite.workforce.gwt.core.server.db.impl.jofc2.util.RotationConverter;
...
public class Label implements Serializable {
    ...
    public enum Rotation {
        VERTICAL(-90), HALF_DIAGONAL(-24), DIAGONAL(-45), HORIZONTAL(0),AGAINST_DIAGONAL(45);
