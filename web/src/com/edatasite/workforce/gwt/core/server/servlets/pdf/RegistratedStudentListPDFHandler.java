 ...
 * Time: 7:43 PM
 */
public class RegistratedStudentListPDFHandler extends AbstractITextPostPdfHandler {
    ...
    protected ITextGenericPdfData buildPdfDocumentCustomise(Object dataClass, EdsCompany company, boolean hasPhantom) {
        ...
        ListResult<StudentItem> studentList = tcService.getScheduledCourseStudents(filterParametrs);
        ListPanelToolRpc panelTools = filterParametrs.getListPanelTool();
        List<StudentItem> studentItems = studentList.getList();
        setFileName(user.getFirstName() + "_" + user.getLastName() + "_" + commonLocalizer.localize(PdfLocalizationName.scheduledCourseStudentList) + "_" + dateFormat(new Date()));
        pdfData.setTableName(commonLocalizer.localizeWithParam(PdfLocalizationName.scheduledStudentListTableName, user.getFullName()));
        ...
        if (studentItems != null) {
            for (StudentItem item : studentItems) {
                ...
                if (panelTools.getColumnCodeName().contains(StudentItem.STUDENT_STATUS)) {
                    columnMap.put(StudentItem.STUDENT_STATUS, getResultOrLongDash(item.getStatus()));
                }
    ...
    protected void setFileName(EdsUser user, Object dataClass) {
        setFileName(user.getFirstName() + "_" + user.getLastName() + commonLocalizer.localize(PdfLocalizationName.scheduledStudentListTableName) + dateFormat(new Date()));
    }
    ...
    protected String getTableName(Object dataClass) {
        return pdfWfmMessageSource.localize("regitratedStudentList");
    }
}
