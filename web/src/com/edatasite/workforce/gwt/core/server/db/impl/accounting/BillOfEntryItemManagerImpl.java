 ...
 */
@Repository("billOfEntryItemManager")
public class BillOfEntryItemManagerImpl extends BaseManager<EdsBillOfEntryItem> implements BillOfEntryItemManager {

    public BillOfEntryItemManagerImpl() {
