 ...
 * Time: 8:51 PM
 */
public class RegistratedStudentListExcelHandler extends BaseExcelHandler {
    ...
    protected void setFileName() {
        filename = "ScheduledCourseStudentList";
    }
    ...
    protected HSSFWorkbook getWorkBook(Object object) {
        ...
        while (totalLength > (start += limit)) {
            ...
            ListResult<StudentItem> courseList = tcService.getScheduledCourseStudents(filterParametrs);
        ...
        try {
            ...
            mapColumnHeader.put(StudentItem.INVOICE_NUMBER, new ExcelData(commonLocalizer.localize(PdfLocalizationName.invoiceNumber), ExcelData.STRING, 20, true, false, ExcelData.NO_BORDER, ExcelData.HEADER));
            mapColumnHeader.put(StudentItem.STUDENT_POINTS, new ExcelData(commonLocalizer.localize(PdfLocalizationName.points), ExcelData.STRING, 20, true, false, ExcelData.NO_BORDER, ExcelData.HEADER));
            mapColumnHeader.put(StudentItem.STUDENT_GRADE_COLUMN, new ExcelData(commonLocalizer.localize(PdfLocalizationName.grade), ExcelData.STRING, 20, true, false, ExcelData.NO_BORDER, ExcelData.HEADER));
            mapColumnHeader.put(StudentItem.STUDENT_EXAM_STATUS, new ExcelData(commonLocalizer.localize(PdfLocalizationName.examStatus), ExcelData.STRING, 20, true, false, ExcelData.NO_BORDER, ExcelData.HEADER));
            mapColumnHeader.put(StudentItem.STUDENT_ATTENDED_STATUS, new ExcelData(commonLocalizer.localize(PdfLocalizationName.attendedStatus), ExcelData.STRING, 20, true, false, ExcelData.NO_BORDER, ExcelData.HEADER));
            mapColumnHeader.put(StudentItem.COURSE_BOOKING, new ExcelData(commonLocalizer.localize(PdfLocalizationName.bookingNumber), ExcelData.STRING, 20, true, false, ExcelData.NO_BORDER, ExcelData.HEADER));
            // Set excell header
            ...
            for (StudentItem course : studentItems) {
                ...
                if (panelTools.getColumnCodeName().contains(StudentItem.INVOICE_NUMBER)) {
                    mapColumn.put(StudentItem.INVOICE_NUMBER, new ExcelData(course.getInvoiceNumber() != null ? course.getInvoiceNumber() : "", ExcelData.STRING, 20, true, false, ExcelData.NO_BORDER, ExcelData.NORMAL));
                }
                if (panelTools.getColumnCodeName().contains(StudentItem.STUDENT_POINTS)) {
                    mapColumn.put(StudentItem.STUDENT_POINTS, new ExcelData(course.getPoints() != null ? course.getPoints() : "", ExcelData.STRING, 20, true, false, ExcelData.NO_BORDER, ExcelData.NORMAL));
                }
                if (panelTools.getColumnCodeName().contains(StudentItem.STUDENT_GRADE_COLUMN)) {
                    mapColumn.put(StudentItem.STUDENT_GRADE_COLUMN, new ExcelData(course.getGrade() != null ? course.getGrade() : "", ExcelData.STRING, 20, true, false, ExcelData.NO_BORDER, ExcelData.NORMAL));
                }
                if (panelTools.getColumnCodeName().contains(StudentItem.STUDENT_EXAM_STATUS)) {
                    mapColumn.put(StudentItem.STUDENT_EXAM_STATUS, new ExcelData(course.getExamStatus() != null ? course.getExamStatus() : "", ExcelData.STRING, 20, true, false, ExcelData.NO_BORDER, ExcelData.NORMAL));
                }
                if (panelTools.getColumnCodeName().contains(StudentItem.STUDENT_ATTENDED_STATUS)) {
                    mapColumn.put(StudentItem.STUDENT_ATTENDED_STATUS, new ExcelData(course.getAttendedStatus() != null ? course.getAttendedStatus() : "", ExcelData.STRING, 20, true, false, ExcelData.NO_BORDER, ExcelData.NORMAL));
                }
                if (panelTools.getColumnCodeName().contains(StudentItem.COURSE_BOOKING)) {
                    mapColumn.put(StudentItem.COURSE_BOOKING, new ExcelData(course.getCourseBookingNumber() != null ? course.getCourseBookingNumber() : "", ExcelData.STRING, 20, true, false, ExcelData.NO_BORDER, ExcelData.NORMAL));
                }
