...
import com.edatasite.workforce.gwt.core.server.db.impl.jofc2.model.elements.BarChart.Bar;
import com.edatasite.workforce.gwt.core.server.db.impl.jofc2.model.elements.LineChart.Dot;
import com.edatasite.workforce.gwt.core.server.db.impl.jofc2.model.elements.PieChart.Slice;
			...
			if (obj != null) {
				if (obj instanceof Number) {
					...
					max = Math.max(max, ((Slice) obj).getValue() != null ? ((Slice) obj).getValue()
							.doubleValue() : 0);
				} else if (obj instanceof com.edatasite.workforce.gwt.core.server.db.impl.jofc2.model.elements.HorizontalBarChart.Bar) {
					max = Math.max(max,
							((com.edatasite.workforce.gwt.core.server.db.impl.jofc2.model.elements.HorizontalBarChart.Bar) obj).getLeft() != null ? ((com.edatasite.workforce.gwt.core.server.db.impl.jofc2.model.elements.HorizontalBarChart.Bar) obj).getLeft()
									.doubleValue()
									: 0);
					max = Math.max(max,
							((com.edatasite.workforce.gwt.core.server.db.impl.jofc2.model.elements.HorizontalBarChart.Bar) obj).getRight() != null ? ((com.edatasite.workforce.gwt.core.server.db.impl.jofc2.model.elements.HorizontalBarChart.Bar) obj).getRight()
									.doubleValue()
									: 0);
