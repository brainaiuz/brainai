 ...
 */
package com.edatasite.workforce.gwt.core.server.db.impl.jofc2;
...
import com.edatasite.workforce.gwt.core.server.db.impl.jofc2.model.Chart;
import com.edatasite.workforce.gwt.core.server.db.impl.jofc2.model.Text;
import com.edatasite.workforce.gwt.core.server.db.impl.jofc2.model.axis.*;
import com.edatasite.workforce.gwt.core.server.db.impl.jofc2.model.elements.*;
...
import com.edatasite.workforce.gwt.core.server.db.impl.jofc2.org.json.JSONObject;
import com.edatasite.workforce.gwt.core.server.db.impl.jofc2.org.json.JSONException;
...
public class OFC {
	...
	public static List<String> stringify(List<? extends Object> source) {
		List<String> strings = new ArrayList<>(source.size());
		for (Object o : source) {
