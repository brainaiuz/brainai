 ...
 * <p>
 * In a first stage, the captcha is created, and the correct answer is stored in the http
 * session.
 * <p>
 * In a second stage, the coordinates of the user's click within the captcha is evaluated.
 *
