 ...
 */
public class ChangeScheduleEventsHandler implements HttpRequestHandler {
    @Autowired
    ...
    public void handleRequest(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        do {
            ...
            processStatus = tcServiceLocal.reGenerateScheduledCourseEvents(listStart, listLimit);
