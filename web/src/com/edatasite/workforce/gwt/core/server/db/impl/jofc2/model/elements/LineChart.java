...
import com.edatasite.workforce.gwt.core.server.db.impl.jofc2.util.DotConverter;
import com.edatasite.workforce.gwt.core.server.db.impl.jofc2.util.TypeDotConverter;
...
public class LineChart extends AnimatedElement {
	...
	@Alias("dot-style")
	private Style dotStyle = new Style(Style.Type.LINE); //default
