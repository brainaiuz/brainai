...
public class NumberToWord_en extends NumberToWord {
    ...
    private static final String[] fractions = {"", " tenths", " hundredth", " thousandths", " ten thousandths", " hundred thousandths", " millionths", " ten millionths", " hundred millionths", " billionths"};
    ...
    public String toWord(Number number) {
        ...
        if (pointIndex > 0) {
            ...
            postfix = postfix.append("and " + decValue + temp);
    ...
    //converts bigdecimal fraction part too
    public String convert(Number number) {
        ...
        if (pointIndex > 0 && (d.compareTo(d.setScale(0, RoundingMode.FLOOR)) != 0)) {
            ...
            String temp = "";
            if (w != "") {
                numberWord.append(" and").append(w);
