...
import com.edatasite.workforce.gwt.core.server.db.impl.jofc2.util.StackKeyConverter;
import com.edatasite.workforce.gwt.core.server.db.impl.jofc2.util.StackValueConverter;
...
public class StackedBarChart extends Element {
    ...
    public Stack newStack() {
        Stack s = new Stack();
        copy(Collections.singletonList(s));
        return s;
    }
