...
public class PlacementNumberingSettingsView extends PMDefaultNumberingSettings {
    public PlacementNumberingSettingsView() {
    }
    ...
    protected void setDefaultParameters() {
        parseAndSetData(null, "", "P", prefixN, startNumber1, startNumber2, startNumber3, startNumber4, "placement");
    }

    @Override
    protected void setSettingsData() {
        parseAndSetData((settings != null ? settings.getPlacementNumberingFormat() : null), (settings != null ? settings.getDelimetrPlacementNumbering() : ""), "P", prefixN, startNumber1, startNumber2, startNumber3, startNumber4, "placement");
    }

    @Override
    protected void setSettings(PMNumberingSettings numberingSettings) {
        super.setSettings(numberingSettings);
        numberingSettings.setPlacementNumberingFormat(moveColumnUserPutForEmpNumber());
        numberingSettings.setDelimetrPlacementNumbering(delimiterN.getText());
    }
