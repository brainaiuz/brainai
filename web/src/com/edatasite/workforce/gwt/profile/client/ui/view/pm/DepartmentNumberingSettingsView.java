...
public class DepartmentNumberingSettingsView extends PMDefaultNumberingSettings {

    public DepartmentNumberingSettingsView() {
    }
    ...
    protected void setDefaultParameters() {
        parseAndSetData(null, "", "DEP", prefixN, startNumber1, startNumber2, startNumber3, startNumber4, "department");
    }

    @Override
    protected void setSettingsData() {
        parseAndSetData((settings != null ? settings.getDepartmentNumberingFormat() : null), (settings != null ? settings.getDelimetrDepartmentFormat() : ""), "DEP", prefixN, startNumber1, startNumber2, startNumber3, startNumber4, "department");
    }

    @Override
    protected void setSettings(PMNumberingSettings numberingSettings) {
        super.setSettings(numberingSettings);
        numberingSettings.setDepartmentNumberingFormat(moveColumnUserPutForEmpNumber());
        numberingSettings.setDelimetrDepartmentFormat(delimiterN.getText());
    }
