...
public class PositionNumberingSettingsView extends PMDefaultNumberingSettings {
    public PositionNumberingSettingsView() {
    }
    ...
    protected void setDefaultParameters() {
        parseAndSetData(null, "", "POS", prefixN, startNumber1, startNumber2, startNumber3, startNumber4, "position");
    }

    @Override
    protected void setSettingsData() {
        parseAndSetData((settings != null ? settings.getPositionNumberingFormat() : null), (settings != null ? settings.getDelimetrPositionNumbering() : ""), "POS", prefixN, startNumber1, startNumber2, startNumber3, startNumber4, "position");
    }

    @Override
    protected void setSettings(PMNumberingSettings numberingSettings) {
        super.setSettings(numberingSettings);
        numberingSettings.setPositionNumberingFormat(moveColumnUserPutForEmpNumber());
        numberingSettings.setDelimetrPositionNumbering(delimiterN.getText());
    }
