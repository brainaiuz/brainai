...
public class ProjectGoalNumberingSettingsView extends PMDefaultNumberingSettings {
    public ProjectGoalNumberingSettingsView() {
    }
    ...
    protected void setDefaultParameters() {
        parseAndSetData(null, "", "Q", prefixN, startNumber1, startNumber2, startNumber3, startNumber4, "projectgoal");
    }

    @Override
    protected void setSettingsData() {
        parseAndSetData((settings != null ? settings.getProjectGoalNumberingFormat() : null), (settings != null ? settings.getDelimetrProjectGoalNumbering() : ""), "Q", prefixN, startNumber1, startNumber2, startNumber3, startNumber4, "projectgoal");
    }

    @Override
    protected void setSettings(PMNumberingSettings numberingSettings) {
        super.setSettings(numberingSettings);
        numberingSettings.setProjectGoalNumberingFormat(moveColumnUserPutForEmpNumber());
        numberingSettings.setDelimetrProjectGoalNumbering(delimiterN.getText());
    }
