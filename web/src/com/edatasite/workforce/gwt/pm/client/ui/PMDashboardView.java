package com.edatasite.workforce.gwt.pm.client.ui;
 ...
 * Date: 28.04.2018 17:00
 */
public class PMDashboardView extends View {

    private Integer dashboardId;
    private DashboardContainer container;

    public PMDashboardView(String name, String description, Integer dashboardId) {
    ...
    protected Widget onInitialize() {
        initialize();
        WfmUiEventsBus.addWfmUiListener(WfmUiEventType.ON_ACCOUNTING_DASHBOARD_CUSTOMIZE, PMDashboardView.this, (sender, args) -> {
            initialize();
        });
        return null;
    }
