...
public class KpiPyramidChart extends AbstractChart {

    public KpiPyramidChart(ChartData chartData, DashboardComponentItem dashboardItem) {
    ...
    protected void configureDataLabel() {
        PyramidDataLabels labels = new PyramidDataLabels();
        setLabels(labels);

        setPyramidPlotOptions(new PyramidPlotOptions()
                .setPyramidDataLabels(labels)
                .setCenter(.5, .5)
                .setDepth(45));
    }
