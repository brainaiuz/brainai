 ...
 */
public class AddCandidateFormViewWithCustomForm extends AbstractAddFormViewWithCustomForm implements Constants {
    ...
    public AddCandidateFormViewWithCustomForm(WebForm webForm, VerticalPanel antibotPanel) {
        ...
        if (!webField.isCustomField()) {
            switch (webField.getSavingField()) {
                ...
                case LeadField.FIELD_PHONE1:
                    ...
                    item.setHomePhone(getPhoneAsString(value));
                    if (validate) {
                        validate(webField, widget);
                    }
                    break;
                case LeadField.FIELD_PHONE2:
                    ...
                    item.setWorkPhone(getPhoneAsString(value));
                    if (validate) {
                        validate(webField, widget);
                    }
                    break;
                case LeadField.FIELD_PHONE3:
                    ...
                    item.setOtherPhone(getPhoneAsString(value));
                    if (validate) {
                        validate(webField, widget);
                    }
                    break;
