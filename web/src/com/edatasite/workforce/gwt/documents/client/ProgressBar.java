...
public class ProgressBar extends VerticalPanelDiv {
     ...
     * Time element text
     */
    private String secondsMessage = wfmStrings.estematedTimeRemaining() + " " + " {0} Seconds";

    private String minutesMessage = wfmStrings.estematedTimeRemaining() + " " + " {0} Minutes";

    private String hoursMessage = wfmStrings.estematedTimeRemaining() + " " + " {0} Hours";
