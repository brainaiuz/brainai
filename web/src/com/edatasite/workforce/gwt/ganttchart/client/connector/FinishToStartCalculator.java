...
public class FinishToStartCalculator implements Calculator {
    ...
    public Point[] calculate(Rectangle r1, Rectangle r2) {
        ...
        Point[] points = null;
        int top = r1.getTop() + r1.getHeight() / 2 + 2;

        if (r1.getRight() <= r2.getLeft()) {

            points = new Point[3];
            points[0] = new Point(r1.getRight() + 2, top);
            points[1] = new Point(r2.getLeft() + 5, top);
			if (r2.getTop() > r1.getTop()) {
				points[2] = new Point(r2.getLeft() + 5, r2.getTop()+1);
			} else {
				points[2] = new Point(r2.getLeft() + 5, r2.getBottom() + r2.getHeight() + 4);
			}
            ...
            */
            ...
            points[2] = new Point(r1.getRight() + 15, r1.getBottom()+5);
            points[3] = new Point(r2.getLeft() - 15, r1.getBottom()+5);
