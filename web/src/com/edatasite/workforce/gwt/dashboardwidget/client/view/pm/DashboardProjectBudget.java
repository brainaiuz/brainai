 ...
 */
public class DashboardProjectBudget extends DashboardBaseWidget {

    public DashboardProjectBudget(DashboardComponentItem componentConf) {
        this.gridItemConfig = componentConf;
    }

    @Override
    protected void getData() {
        DashboardWidgetService.App.get().geProjectBudget(new AsyncCallback<ChartData>() {
            @Override
