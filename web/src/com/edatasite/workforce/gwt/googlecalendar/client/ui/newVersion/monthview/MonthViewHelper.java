...
/**
 * Contains utilities with logic required to generate the {@link MonthView}.
 */
public class MonthViewHelper {
    ...
    public static int monthViewRequiredRows(Date firstOfTheMonth, int weekStart) {
        int requiredRows = 5;
        ...
        firstDayInCalendar = DateUtil.getWeekFirstDay(firstDayInCalendar, weekStart - 1);
