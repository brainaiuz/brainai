...
public class AppointmentManager {
     ...
     *
     * @param selectedAppointment The appointment to consider &quot;currently selected&quot;
     */
    ...
    public boolean selectPreviousAppointment() {
        ...
        if (getSelectedAppointment() != null) {
            ...
            if (selectedApptIndex > 0 && (prevAppt = getAppointments().get(selectedApptIndex - 1)) != null) {
    ...
    public boolean selectNextAppointment() {
        ...
        if (getSelectedAppointment() != null) {
            ...
            if (selectedApptIndex < lastIndex && (nextAppt = getAppointments().get(selectedApptIndex + 1)) != null) {
    ...
    public ArrayList<Appointment> getAppointmentsByRecurring(Appointment recurringAppointment) {
        ...
        if (appointments != null) {
            for (Appointment appointment : appointments) {
                if (recurringAppointment.getRecurrenceId() != null && appointment.getRecurrenceId() != null && appointment.getRecurrenceId().equals(recurringAppointment.getRecurrenceId())) {
                    if (recurringAppointment.getAction().equals(Constants.DELETE_ALL_FOLLOWING)) {
                        if (appointment.getStartDate().after(recurringAppointment.getStartDate())) {
                            result.add(appointment);
                        }
                    } else if (recurringAppointment.getAction().equals(Constants.DELETE_ALL_SERIES)) {
                        result.add(appointment);
                    }
                }
            }
