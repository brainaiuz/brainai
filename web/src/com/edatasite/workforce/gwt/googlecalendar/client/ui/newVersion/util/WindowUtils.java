...
public class WindowUtils {
    ...
    public static Rectangle getAllowedParameter(Rectangle parameter) {
        int windowWidth = Window.getClientWidth();
        int windowHeight = Window.getClientHeight();

        int left = parameter.getLeft();
        int top = parameter.getTop();
        int width = parameter.getOffsetWidth();
        int height = parameter.getOffsetHeight();

        int relativeX = left + width;
        int relativeY = top + height;
