...
import com.edatasite.workforce.gwt.client.client.ClientAddSinksContainer;
...
public class ClientHistoryProcessor implements HistoryProcessor {
    ...
    public ClientHistoryProcessor() {

    }

    public ClientHistoryProcessor(String section) {
    ...
    public SinksContainer processAdd(String[] params) {
        return new ClientAddSinksContainer("clientadd", Property.get(Constants.CLIENT_LIST, wfmStrings.addMess(), wfmStrings.customer()), params);
    }
