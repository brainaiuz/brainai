...
/**
 * User: Mahkamov Mohirbek
 * Date: 02.06.2022 15:00
 */
public class LeavePlannerGanttChartCustomizeSideNav extends KpiSideNavBox {
    ...
    public LeavePlannerGanttChartCustomizeSideNav() {
        super();
        this.initialize();
    }
    ...
    private void initialize() {
        ...
        saveButton.addClickHandler(event -> {
            hide();
            WfmUiEventsBus.fireWfmUiEvent(WfmUiEventType.ON_GANTT_CHART_COLUMN_SETTINGS_CHANGE, null, LeavePlannerGanttChartCustomizeSideNav.this);
        });
        addHeader(header);
