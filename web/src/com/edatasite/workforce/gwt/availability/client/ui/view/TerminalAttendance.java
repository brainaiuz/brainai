 ...
 */
public class TerminalAttendance extends View implements FittedContent, Colapse {
    ...
    public TerminalAttendance() {
        super("terminalAttendance");
        setDescription(hrmsStrings.terminalAttendance());
    }
    ...
    protected Widget onInitialize() {
        if (brigadaIds != null) {
            add(new TerminalAttendanceView(brigadaIds, shiftPeriod));
        } else {
            add(new TerminalAttendanceView());
        }
        return null;
    }
