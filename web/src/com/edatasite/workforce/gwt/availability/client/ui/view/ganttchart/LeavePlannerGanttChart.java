package com.edatasite.workforce.gwt.availability.client.ui.view.ganttchart;
 ...
 */
public class LeavePlannerGanttChart extends Composite {
    ...
    public LeavePlannerGanttChart(ChartData chartData, HTMLPanel rootPanel) {
        this.chartData = chartData;
        this.rootPanel = rootPanel;
    }

    public LeavePlannerGanttChart(ChartData chartData, List<SelectItem> columns) {
        this.chartData = chartData;
    ...
    private native JavaScriptObject nativeInitialize(JavaScriptObject options) /*-{
        if ($wnd.$('#gantt-container')) {
            ...
            setTimeout(function () {
                ...
                that.@com.edatasite.workforce.gwt.availability.client.ui.view.ganttchart.LeavePlannerGanttChart::setChart(Lcom/google/gwt/core/client/JavaScriptObject;)(chart);
            }, 1000);
        } else {
    ...
    interface LeaveGwtGanttChartUIBinder extends UiBinder<HTMLPanel, LeavePlannerGanttChart> {
    }
}
