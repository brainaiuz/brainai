...
public class OpportunityHistoryListView extends BaseListView implements Constants {
    private final Integer entityID;
    private ListingPanel<LogHistoryItem> list;

    public OpportunityHistoryListView(Integer entityID) {
        super(OPPORTUNITY_UPDATES_LIST, wfmStrings.logHistory());
        this.entityID = entityID;
    }

    @Override
    protected Widget onInitialize() {
        list = new ListingPanel<>(ListPanelType.OpportunityHistoryListView, getColumns(), getRequestProvider(), getPanelDesigner());
        add(list);
        return null;
    }
    ...
    private ListingRequestProvider<LogHistoryItem> getRequestProvider() {
        return (listingFilterParameter, listingCallback) -> {
            ...
            CRMService.App.get().getOpportunityLogHistoryList(listingFilterParameter, new AsyncCallback<ListResult<LogHistoryItem>>() {
                @Override
