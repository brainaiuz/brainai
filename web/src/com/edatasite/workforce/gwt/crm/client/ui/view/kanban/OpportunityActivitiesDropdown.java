 ...
 */
public class OpportunityActivitiesDropdown extends Composite implements PermissionConstants {

    interface LeadActivitiesDropdownUiBinder extends UiBinder<Widget, OpportunityActivitiesDropdown> {
    }
...
//    
    ...
    public OpportunityActivitiesDropdown(OpportunityListItem kanbanItem) {
        super();
...
//            MaterialPanel checklistContainer = new MaterialPanel("wg_canban__dropdown-text");
    ...
    public void addTaskLinkOurClick(ClickEvent event) {
        if (kanbanItem != null) {
            new TaskQuickAddView(RelationItem.newEventRelation(RelationItem.TYPE_OPPORTUNITY, kanbanItem.getObjectId(), kanbanItem.getOpportunityName()),
                    RelationItem.newEventRelation(RelationItem.TYPE_CRM_ACCOUNT, kanbanItem.getCrmAccountItem().getObjectId() != null ? kanbanItem.getCrmAccountItem().getObjectId() : null,
                            kanbanItem.getCrmAccountItem().getName() != null ? kanbanItem.getCrmAccountItem().getName() : null));
        }
    }
    ...
    public void addEventLinkOurClick(ClickEvent event) {
        if (kanbanItem != null) {
            new ActivityQuickAddForm(Appointment.EVENT, RelationItem.newEventRelation(RelationItem.TYPE_OPPORTUNITY,
                    kanbanItem.getObjectId(), kanbanItem.getOpportunityName()), RelationItem.newEventRelation(RelationItem.TYPE_CRM_ACCOUNT,
                    kanbanItem.getCrmAccountItem().getObjectId(), kanbanItem.getCrmAccountItem().getName()));
        }
    }
}
