...
public class OpportunityReceiptTable extends Composite {
    interface TotalTableUiBinder extends UiBinder<HTMLPanel, OpportunityReceiptTable> {
    }
    ...
    public OpportunityReceiptTable() {
