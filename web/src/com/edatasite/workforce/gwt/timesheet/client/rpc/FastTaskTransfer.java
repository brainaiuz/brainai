...
public class FastTaskTransfer extends SelectItem {
    ...
    private TimesheetDataItem[] dataItems;
    ...
    public FastTaskTransfer(Integer id, String name) {
        super(id, name);
        this.emplTaskId = getId();
        this.emplTaskName = getName();
        this.taskStatus = new TaskStatus();
    ...
    public TimesheetDataItem[] getDataItems() {
        return dataItems;
    }

    public void setDataItems(TimesheetDataItem[] dataItems) {
