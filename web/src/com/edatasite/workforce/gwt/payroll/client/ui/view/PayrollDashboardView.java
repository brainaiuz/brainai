...
public class PayrollDashboardView extends View {
    private final Integer dashboardId;
    private DashboardContainer container;


    public PayrollDashboardView(String name, String description, Integer dashboardId) {
    ...
    protected Widget onInitialize() {
        initialize();
        WfmUiEventsBus.addWfmUiListener(WfmUiEventType.ON_ACCOUNTING_DASHBOARD_CUSTOMIZE, PayrollDashboardView.this, (sender, args) -> {
            initialize();
        });
        return null;
    }
