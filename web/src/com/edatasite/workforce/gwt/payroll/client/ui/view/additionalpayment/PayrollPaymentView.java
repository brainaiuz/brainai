...
public class PayrollPaymentView extends PayrollPaymentAddView {
    ...
    public PayrollPaymentView(Integer id) {
        this("view");
        objectID = id;
        setDescription(wfmStrings.payment());
    }

    public PayrollPaymentView(String name) {
        super(name);
    }
    ...
    protected void loadData() {
        ...
        PayrollService.App.get().getPayrollPayment(fp, new AsyncCallback<PayrollPayment>() {
            @Override
    ...
    private void setMainData(PayrollPayment result) {
