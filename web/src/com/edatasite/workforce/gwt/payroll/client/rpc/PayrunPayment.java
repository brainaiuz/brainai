...
public class PayrunPayment implements IsSerializable {
    ...
    private ArrayList<PayrunPaymentItem> items;
    private Integer totalItems;

    private HashMap<Integer, PayrunPaymentItem> changedItems;
    ...
    public ArrayList<PayrunPaymentItem> getItems() {
        return items;
    }

    public void setItems(ArrayList<PayrunPaymentItem> items) {
        this.items = items;
    }
    ...
    public HashMap<Integer, PayrunPaymentItem> getChangedItems() {
        return changedItems;
    }

    public void setChangedItems(HashMap<Integer, PayrunPaymentItem> changedItems) {
