...
/**
 * User: ASUS
 * Date: 22.02.2016 17:43
 */
public class TimeSlotHistoryTab extends Composite {

    private Integer timeSlotId;
    private boolean isShift;
    private FlexTable historyTable;
    private ScrollPanel scrollPanel;
    private final AvailabilityServiceAsync timeSlotService = AvailabilityService.App.get();
    private static final HrmsStrings hrmsStrings = HrmsStrings.App.get();
    FlowPanel container = new FlowPanel();

    public TimeSlotHistoryTab(Integer objectID, boolean isShift) {
        super();
        this.timeSlotId = objectID;
        this.isShift = isShift;
        WfmUiEventsBus.addWfmUiListener(WfmUiEventType.ON_TIMESLOT_ADD, TimeSlotHistoryTab.this, (sender, args) -> refresh());
        WfmUiEventsBus.addWfmUiListener(WfmUiEventType.ON_TIMESLOT_EDIT, TimeSlotHistoryTab.this, (sender, args) -> refresh());
        WfmUiEventsBus.addWfmUiListener(WfmUiEventType.ON_TIMESLOT_DELETE, TimeSlotHistoryTab.this, (sender, args) -> refresh());
    ...
    public void refresh() {
        timeSlotService.getTimeSlotHistories(timeSlotId, isShift, new AbstractAsyncCallback<TimeSlotHistoryList[]>() {
            @Override
            public void failure(Throwable caught) {
            }

            @Override
            public void success(TimeSlotHistoryList[] result) {
                historyTable.clear();
    ...
    private void getHistoryList(TimeSlotHistoryList[] historyLists) {
...
//                container.clear();
            ...
            getEmptyPanel(hrmsStrings.noTimeSlotHistory(), null, null);
        }
