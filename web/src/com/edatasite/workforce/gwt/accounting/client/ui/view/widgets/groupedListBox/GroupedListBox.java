package com.edatasite.workforce.gwt.accounting.client.ui.view.widgets.groupedListBox;
...
public class GroupedListBox extends ListBox {
    ...
    private HashMap<String, Integer> itemsById = new LinkedHashMap<>();
    ...
    public void setSelectedByValue(String id){
        setSelectedIndex(itemsById.get(id));
    }
    ...
    public void insertItem(String item, String value, int index) {
        ...
        itemsById.put(value, option.getIndex());
    }
