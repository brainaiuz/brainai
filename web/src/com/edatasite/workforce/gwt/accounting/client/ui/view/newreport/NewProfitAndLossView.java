 ...
 */
public class NewProfitAndLossView extends View implements Colapse, AccountingConstants, FittedContent {
    ...
    public NewProfitAndLossView() {
        super("newprofitLoss");
        setDescription(property.getPlural(accountingStrings.profitAndLoss()));
    }

    public NewProfitAndLossView(String[] params) {
        this();
        this.params = params;
    }
    ...
    protected Widget onInitialize() {
        NewProfitAndLoss newProfitAndLoss;
        if (params != null && params.length > 0) {
            newProfitAndLoss = new NewProfitAndLoss(params);
        } else {
            newProfitAndLoss = new NewProfitAndLoss();
        }
        add(newProfitAndLoss);
        return null;
    }
    ...
    public String getIconStyle() {
        return "accountMark profit-and-loss";
    }
