 ...
 */
public class BudgetManagerItems implements IsSerializable {
    ...
    private BudgetManagerItem budgetManagerDetail;
    ...
    public BudgetManagerItem getBudgetManagerDetail() {
        return this.budgetManagerDetail;
    }

    public void setBudgetManagerDetail(final BudgetManagerItem budgetManagerDetail) {
        this.budgetManagerDetail = budgetManagerDetail;
    }
}
