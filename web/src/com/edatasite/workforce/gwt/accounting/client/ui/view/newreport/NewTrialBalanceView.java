...
import com.edatasite.workforce.gwt.accounting.client.ui.view.newreport.TrialBalance.NewTrialBalance;
 ...
 */
public class NewTrialBalanceView extends View implements Colapse, AccountingConstants, FittedContent {


    private static final AccountingStrings accountingStrings = AccountingStrings.App.get();

    public NewTrialBalanceView() {
        super("trialBalance");
        setDescription(property.getPlural(wfmStrings.trialBalance()));
    }

    @Override
    protected Widget onInitialize() {
        LoadingPanel.loading(true);
        add(new NewTrialBalance());
        return null;
    }
