...
import com.edatasite.workforce.gwt.accounting.client.ui.view.newreport.TrialBalance.TrialBalanceDetailed;
...
public class TrialBalanceDetailedView extends View implements Colapse, AccountingConstants, FittedContent {


    private static final AccountingStrings accountingStrings = AccountingStrings.App.get();

    public TrialBalanceDetailedView() {
        super("trialBalance", wfmStrings.trialBalance());
    }

    @Override
    protected Widget onInitialize() {
        LoadingPanel.loading(true);
        add(new TrialBalanceDetailed());
        return null;
    }
