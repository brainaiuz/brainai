 ...
 */
public class Accounting extends WorkforceEntryPoint {
    ...
    protected void loadUserDashboards() {
        ...
        fp.setModule(ModuleEnum.ACCOUNTING.getCode());
        fp.setLimit(50);
    ...
    public void initSinksContainerFactory() {
        ...
        if (Utils.hasPermission(PermissionConstants.ACCOUNTING_MAIN_MENU)) {
            containerFactory = new AccountingSinksContainerFactory(this);
        } else {
