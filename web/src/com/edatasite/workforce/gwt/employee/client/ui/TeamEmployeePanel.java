...
public class TeamEmployeePanel extends Div implements Constants, Errors {
    ...
    private ViewFooter createFooter() {
        return new ViewFooter(new IFooteredView() {
            ...
            public List<Widget> getFooterLeftSideWidgets() {
                return TeamEmployeePanel.this.getFooterLeftSideWidgets();
            }

            @Override
            public List<Widget> getFooterRightSideWidgets() {
                return TeamEmployeePanel.this.getFooterRightSideWidgets();
            }
        });
    }
...
//                customRoles = customRoleList;
    ...
    private void refreshOnDemand() {
        ...
        WfmUiEventsBus.fireWfmUiEvent(WfmUiEventType.ON_EMPLOYEE_ADD, newEmployees, TeamEmployeePanel.this);
