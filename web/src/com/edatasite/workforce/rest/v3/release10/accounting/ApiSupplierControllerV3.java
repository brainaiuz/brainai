 ...
 */
@Tag(name = "Suppliers", description = "Suppliers Public API")
@RestController
@RequestMapping(headers = {ApiConstants.ACCESS_TOKEN, ApiConstants.X_AUTH},
        produces = {MediaType.APPLICATION_JSON_UTF8_VALUE})
public class ApiSupplierControllerV3 extends BaseApiControllerV3 {
    ...
    public Object add(@RequestBody CustomerAddDTO customerAddDTO) throws RestException {
        ...
        try {
            Integer result = crmServiceLocal.saveAccount(crmAccountItem, CrmAccountItem.SUPPLIER, null, false, false, false, true);
            if (result < 0) {
    ...
    public Object getCustomerAddresses(@PathVariable(value = "id") Integer id) throws RestException {
        ...
        if (edsCrmAccount == null) {
            throw new RestException(GENERAL_ERROR_MESSAGE, "There is no supplier with id: " + id, NOT_FOUND, HttpStatus.NOT_FOUND);
        }
