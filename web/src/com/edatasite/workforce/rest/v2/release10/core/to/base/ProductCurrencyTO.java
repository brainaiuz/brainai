...
public class ProductCurrencyTO extends ResponseData {
    private Integer id;
    private String international_code;
    private BigDecimal exchange_rate;

    public ProductCurrencyTO() {
    }

    public ProductCurrencyTO(Integer id, String international_code, BigDecimal exchange_rate) {
        this.id = id;
