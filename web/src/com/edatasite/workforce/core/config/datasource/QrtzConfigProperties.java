...
@Configuration
public class QrtzConfigProperties {
    /**
     * database url
     */
     ...
     */
    @Value("${quartz.datasource.hikari.connectionTimeout}")
     ...
     */
    @Value("${quartz.datasource.hikari.maxPoolSize}")
     ...
     */
    @Value("${quartz.datasource.hikari.idleTimeout}")
     ...
     */
    @Value("${quartz.datasource.hikari.minIdle}")
    private int minIdle;
     ...
     */
    @Value("${quartz.datasource.hikari.leakDetectionThreshold}")
    private int leakDetectionThreshold;

    /**
     * The name for the master database connection pool
     */
    @Value("${quartz.datasource.hikari.poolName}")
