...
@Configuration
public class ReportingDatabaseConfigProperties {
    /**
     * database url
     */
     ...
     */
    @Value("${reporting.datasource.hikari.connectionTimeout}")
     ...
     */
    @Value("${reporting.datasource.hikari.maxPoolSize}")
     ...
     */
    @Value("${reporting.datasource.hikari.idleTimeout}")
     ...
     */
    @Value("${reporting.datasource.hikari.minIdle}")
    private int minIdle;
     ...
     */
    @Value("${reporting.datasource.hikari.leakDetectionThreshold}")
    private int leakDetectionThreshold;

    /**
     * The name for the master database connection pool
     */
    @Value("${reporting.datasource.hikari.poolName}")
