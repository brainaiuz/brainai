...
public class HikariConfigProperties {
     ...
     */
    @Value("${tenant.datasource.hikari.connectionTimeout}")
     ...
     */
    @Value("${tenant.datasource.hikari.maxPoolSize}")
     ...
     */
    @Value("${tenant.datasource.hikari.idleTimeout}")
     ...
     */
    @Value("${tenant.datasource.hikari.minIdle}")
    private int minIdle;
     ...
     */
    @Value("${tenant.datasource.hikari.leakDetectionThreshold}")
    private int leakDetectionThreshold;

    /**
     * The name for the master database connection pool
     */
    @Value("${tenant.datasource.hikari.poolName}")
