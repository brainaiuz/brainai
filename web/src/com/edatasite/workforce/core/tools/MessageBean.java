...
public final class MessageBean extends BodypartBean implements java.io.Serializable {
    ...
    static final Logger logger = LoggerFactory.getLogger(MessageBean.class);
    ...
    private String wfmClusterType, wfmCompanyID, wfmMessageID, wfmEntityID;
    ...
    private String addrToString(Address[] addr) {
        ...
        StringBuilder str = new StringBuilder(addr[0].toString());
        for (int i = 1; i < addr.length; i++) {
            str.append(",").append(addr[i].toString());
        }
        return str.toString();
    }
    ...
    public String getWfmClusterType() {
        return wfmClusterType;
    }

    public void setWfmClusterType(String wfmClusterType) {
        this.wfmClusterType = wfmClusterType;
    }

    public String getWfmCompanyID() {
        return wfmCompanyID;
    }

    public void setWfmCompanyID(String wfmCompanyID) {
        this.wfmCompanyID = wfmCompanyID;
    }

    public String getWfmMessageID() {
        return wfmMessageID;
    }

    public void setWfmMessageID(String wfmMessageID) {
        this.wfmMessageID = wfmMessageID;
    }

    public String getWfmEntityID() {
        return wfmEntityID;
    }

    public void setWfmEntityID(String wfmEntityID) {
        this.wfmEntityID = wfmEntityID;
    }
    ...
    public String toString() {
        ...
        if (xmailer != null && xmailer.length > 0) {
            for (String aXmailer : xmailer) {
                sb.append("X-Mailer: " + aXmailer + LF);
            }
        }
        if (priority != null && priority.length > 0) {
            for (String aPriority : priority) {
                sb.append("Priority: " + aPriority + LF);
            }
        }
        ...
        if (attachments != null && attachments.size() > 0) {
            ...
            for (MessageNode node : attachments) {
