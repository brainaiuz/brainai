 ...
 */
@Entity
@Table(schema = EdsScope.PUBLIC_SCHEMA, name = "Message")
public class EdsMessage extends EdsSuperMessage {
    @ManyToMany(fetch = FetchType.LAZY)
   @JoinTable(schema = EdsScope.PRIVATE_SCHEMA, name = "message_upload",
