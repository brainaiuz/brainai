...
public class EditableGrid<T extends Editable> extends SimpleGrid implements AdvancedWidget {
     ...
     */
    private Map<Integer, Boolean> readOnlyColumns = new HashMap<>();
    /**
     ...
     */
    private Map<Integer, Boolean> sortableHeaders = new HashMap<>();
    /**
    ...
    public void addInvisibleColumn(int column) {
        ...
        columns.remove(Integer.valueOf(column));
        columns.add(column);
    }
    ...
    public boolean isVisible(int column) {
        return !getInvisibleColumns().contains(column);
    }
    ...
    public boolean fireFinishEdit(GridCell cell, Object newValue) {
        ...
        if (result) {
//            updateModel(cell, newValue); TODO it doesn't work correctly!!!
     ...
     * @param step     is an increase stage.
     */
