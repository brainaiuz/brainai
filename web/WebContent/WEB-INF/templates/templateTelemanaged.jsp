...
<head>
    ...
    <link rel="shortcut icon" href="/customisation/telemanaged.com/images/favicon.ico" type="image/x-icon"/>
    ...
    <div id="head">
        ...
        <div id="block-block-4" class="clear-block block block-block">
            ...
            <div class="content"><a id="logo-site" href="/">
                <img src="/customisation/telemanaged.com/images/logo.png" alt="Site Name"/>
            </a>
...
<div id="footer">
    ...
    <div class="clear c-box">
        ...
        <div class="copyright">2007 - 2012 &copy;
            <a href="/">Telemanaged</a>  <fmt:message key="frontendmain.allRightsReserved"/>
        </div>
    </div>
</div>
<!--END #footer-->
