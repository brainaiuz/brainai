...
<head>
    ...
    <title>Sign in to folioone.uz</title>
    <link rel="shortcut icon" href="/customisation/folioone/images/favicon.ico" type="image/x-icon"/>
...
<div class="pg_landing">
    <div class="pg_landing__container">
        <figure class="pg_landing__header" style="margin-top: 70px;">
            <div class="pg_landing__logo">
                <a href="#">
                    <img src="/customisation/folioone/images/logo.png" alt="logo" style="width: 250px !important;"/>
                </a>
            </div>
