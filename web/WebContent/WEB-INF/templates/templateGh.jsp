...
<head>
    ...
    <link rel="shortcut icon" href="/customisation/gh/images/favicon.ico" type="image/x-icon"/>
    ...
    <div class="pg_landing__container">
        <figure class="pg_landing__header" style="margin-top: 50px;">
            <div class="pg_landing__logo">
                <a href="#">
                    <img src="/customisation/gh/images/logo.jpg" alt="logo" style="width: 200px !important;"/>
                </a>
            </div>
        </figure>
