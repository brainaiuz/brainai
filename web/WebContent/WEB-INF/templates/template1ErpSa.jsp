...
<head>
    ...
    <link rel="stylesheet" href="/customisation/1erp.sa/style.css"/>
    <link rel="stylesheet" href="/customisation/1erp.sa/appFrame.css"/>
    <link rel="stylesheet" href="/customisation/1erp.sa/master.css"/>
    <link href="/customisation/1erp.sa/images/favicon.ico" rel="shortcut icon">
    <!--[if lt IE 9]>
    ...
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="/customisation/1erp.sa/fix-ie.css"/>
    <![endif]-->

    <script type="text/javascript" src="/customisation/1erp.sa/scripts/jquery.js"></script>
    <script type="text/javascript" src="/customisation/1erp.sa/scripts/common.js"></script>

    <SCRIPT type=text/javascript src="/customisation/1erp.sa/jquery.placeholder.min.js"></SCRIPT>
...
<header>
    <div class="ZoneIn">
        ...
        <!-- begin logo site -->
        <a href="//www.1erp.sa" id="logo">
            <img src="/customisation/1erp.sa/images/logo.png">
        </a>
        ...
        <hgroup>
            ...
            <div class="langBar">
                ...
                <%--<li><a href="//1erp.sa/o-que-o-workforcetrack-representa-e-por-que-precisamos-dele"--%>
                <%--class="langPo">Portuguese</a></li>--%>
                <%--<li><a href="http://www.1erp.sa.ru/" class="langRU">Russian</a></li>--%>
                <%--<li><a href="//1erp.sa/kpi-com-nedir-ve-neden-ihtiyacim-var" class="langTU">Turkey</a></li>--%>
                <%--</ul>--%>
            </div>

            <div class="sitePhone">
                <em>Need Help?</em>
                <span>+966138322299</span>
            </div>
        ...
        <nav class="menu-main-menu-container">
            ...
            <%--id="menu-item-2170">--%>
            <%--<a href="//1erp.sa/about/">About</a>--%>
            <%--<ul class="sub-menu">--%>
            <%--<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-590"--%>
            <%--id="menu-item-590"><a href="//1erp.sa/about-kpi-com/">About 1erp.sa</a></li>--%>
            <%--<li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-643"--%>
            <%--id="menu-item-643"><a href="//1erp.sa/category/press-release/">Press Release</a></li>--%>
            <%--<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-683"--%>
            <%--id="menu-item-683"><a href="//1erp.sa/customers/">Customers</a></li>--%>
            <%--<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-689"--%>
            <%--id="menu-item-689"><a href="//1erp.sa/legal/">Legal</a></li>--%>
        ...
        <footer>
            ...
            <ul class="menu" id="menu-stay-connected">
                <li class="markEmail socialBookMark menu-item menu-item-type-custom menu-item-object-custom menu-item-18"
                    id="menu-item-18">
                    <a href="mailto:support@1erp.sa" target="_blank">Email</a>
                </li>
                ...
                <li class="markLinkedin socialBookMark menu-item menu-item-type-custom menu-item-object-custom menu-item-20"
                    id="menu-item-20">
                    <a href="//www.linkedin.com/company/362805" target="_blank">LinkedIn</a>
                </li>
            ...
            <div class="footCaption">
                <a href="//1erp.sa/" id="foot-logo">
                    <img alt="Logo" src="/customisation/1erp.sa/images/image001.png">
                </a>
                <span>Powered by Sahara Net</span>
                ...
                <p>
                    ...
                    %>
                    <%=year%> &copy; 1erp.sa All Rights Reserved.<br>
                    <a href="//1erp.sa/legal">Terms of Use</a> | <a href="//1erp.sa/legal">Privacy Policy</a>
                </p>
            </div>
...
<%--_gaq.push(['_setDomainName', '.1erp.sa']);--%>
