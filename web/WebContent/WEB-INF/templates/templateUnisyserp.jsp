...
<head>
    ...
    <link rel="stylesheet" href="/customisation/unisyserp.com/style.css"/>
    <link rel="stylesheet" href="/customisation/unisyserp.com/appFrame.css"/>
    <link rel="stylesheet" href="/customisation/unisyserp.com/master.css"/>
    <!-- <link href="//app.unisyserp.com/customisation/unisyserp.com/images/favicon.ico" rel="shortcut icon">-->
    <!--[if lt IE 9]>
    ...
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="/customisation/unisyserp.com/fix-ie.css"/>
    <![endif]-->

    <script type="text/javascript" src="/customisation/unisyserp.com/scripts/jquery.js"></script>
    <script type="text/javascript" src="/customisation/unisyserp.com/scripts/common.js"></script>

    <SCRIPT type=text/javascript src="/customisation/unisyserp.com/jquery.placeholder.min.js"></SCRIPT>
...
<header>
    <div class="ZoneIn">
        ...
        <!-- begin logo site -->
        <a href="http://www.unisysint.com/solutions/unisyserp/" id="logo">
            <img style="margin-left: -28px;" src="/customisation/unisyserp.com/images/logo.png">
        </a>
    ...
    <div id="content" class="full-main">
        ...
        <footer>
            ...
            <div class="footCaption">
                <a href="//unisyserp.com/" id="foot-logo">
                    <img alt="Logo" style="width:130px;height:36px;"
                         src="/customisation/unisyserp.com/images/foot_logo.png">
                </a>
                <span>Unisys International</span>
                ...
                <p>
                    ...
                    %>
                    <%=year%> &copy; unisyserp.com All Rights Reserved.<br>
                    <a href="//unisyserp.com/legal">Terms of Use</a> | <a href="//unisyserp.com/legal">Privacy
                    Policy</a>
                </p>
            </div>
