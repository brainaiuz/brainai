...
<head>
    ...
    <link rel="stylesheet" href="/customisation/vipworkspace.com/style.css"/>
    <link rel="stylesheet" href="/customisation/vipworkspace.com/appFrame.css"/>
    <link rel="stylesheet" href="/customisation/vipworkspace.com/master.css"/>
    <link href="/customisation/vipworkspace.com/images/favicon.ico" rel="shortcut icon">
    <!--[if lt IE 9]>
    ...
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="/customisation/vipworkspace.com/fix-ie.css"/>
    <![endif]-->

    <script type="text/javascript" src="/customisation/vipworkspace.com/scripts/jquery.js"></script>
    <script type="text/javascript" src="/customisation/vipworkspace.com/scripts/common.js"></script>

    <SCRIPT type=text/javascript src="/customisation/vipworkspace.com/jquery.placeholder.min.js"></SCRIPT>
...
<header>
    <div class="ZoneIn">
        ...
        <!-- begin logo site -->
        <a href="//vipworkspace.com" id="logo">
            <img src="/customisation/vipworkspace.com/images/logo.png">
        </a>
        ...
        <footer>
            ...
            <ul class="menu" id="menu-stay-connected">
                <li class="markEmail socialBookMark menu-item menu-item-type-custom menu-item-object-custom menu-item-18"
                    id="menu-item-18">
                    <a href="mailto:support@vipworkspace.com" target="_blank">Email</a>
                </li>
            ...
            <div class="footCaption">
                <a href="//vipworkspace.com/" id="foot-logo">
                    <img alt="Logo" src="/customisation/vipworkspace.com/images/foot_logo.png">
                </a>
                ...
                <p>
                    ...
                    %>
                    <%=year%> &copy; vipworkspace.com All Rights Reserved.<br>
                    <a href="//vipworkspace.com/legal">Terms of Use</a> | <a href="//vipworkspace.com/legal">Privacy Policy</a>
                </p>
            </div>
