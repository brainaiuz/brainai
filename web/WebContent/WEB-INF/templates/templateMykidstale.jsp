...
<head>
    ...
    <link rel="stylesheet" href="/customisation/mykidstale/style.css"/>
    <link rel="stylesheet" href="/customisation/mykidstale/appFrame.css"/>
    <link rel="stylesheet" href="/customisation/mykidstale/master.css"/>
    <link href="//app.mykidstale.com/customisation/mykidstale/images/favicon.ico" rel="shortcut icon">
    <!--[if lt IE 9]>
    ...
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="/customisation/mykidstale/fix-ie.css"/>
    <![endif]-->

    <script type="text/javascript" src="/customisation/mykidstale/scripts/jquery.js"></script>
    <script type="text/javascript" src="/customisation/mykidstale/scripts/common.js"></script>

    <SCRIPT type=text/javascript src="/customisation/mykidstale/jquery.placeholder.min.js"></SCRIPT>
...
<!--begin header-->
<header>
    <div class="ZoneIn" style="height:80px;">

        <!-- begin logo site -->
        <a href="//mykidstale.com" id="logo">
            <img src="/customisation/mykidstale/images/logo.png">
        </a>
        ...
        <hgroup>
            ...
            <%--<li><a href="//mykidstale.com/o-que-o-workforcetrack-representa-e-por-que-precisamos-dele" class="langPo">Portuguese</a></li>--%>
            <%--<li><a href="http://www.mykidstale.ru/" class="langRU">Russian</a></li>--%>
            <%--<li><a href="//mykidstale.com/kpi-com-nedir-ve-neden-ihtiyacim-var" class="langTU">Turkey</a></li>--%>
            <%--</ul>--%>
            <%--</div>--%>

            <div class="sitePhone">
                <%--<em>Need Help?</em>
                <span>407-965-1765</span>--%>
            </div>
        ...
        <nav class="menu-main-menu-container">
            <%--<ul class="menu" id="menu-main-menu">
                ...
                <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-2170"
                    id="menu-item-2170">
                    <a href="//mykidstale.kpi.com/about/">About</a>
                    <ul class="sub-menu">
                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-590"
                            id="menu-item-590"><a href="//mykidstale.kpi.com/about-kpi-com/">About mykidstale.kpi.com</a></li>
                        <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-643"
                            id="menu-item-643"><a href="//mykidstale.kpi.com/category/press-release/">Press Release</a></li>
                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-683"
                            id="menu-item-683"><a href="//mykidstale.kpi.com/customers/">Customers</a></li>
                        <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-689"
                            id="menu-item-689"><a href="//mykidstale.kpi.com/legal/">Legal</a></li>
                        <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2 current_page_item menu-item-559"
                            id="menu-item-559"><a href="//mykidstale.kpi.com/careers/">Careers</a></li>
                        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1750"
                            id="menu-item-1750"><a href="http://blog.mykidstale.kpi.com/">Blog</a></li>
                    </ul>
                </li>
                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-592" id="menu-item-592">
                    <a href="//mykidstale.kpi.com/contact-us/">Contact Us</a>
                </li>
            </ul> --%>
        </nav>
        ...
        <footer>
            ...
            <%-- <ul class="menu" id="menu-stay-connected">
                 <li class="markEmail socialBookMark menu-item menu-item-type-custom menu-item-object-custom menu-item-18"
                     id="menu-item-18">
                     <a href="mailto:support@mykidstale" target="_blank">Email</a>
                 </li>
            ...
            <%--  <div class="footCaption">
                  <a href="//mykidstale.com/" id="foot-logo">
                      <img alt="Logo" src="/customisation/mykidstale/images/foot_logo.png">
                  </a>
                  <span>Powered by Community Benefits Group, Inc.</span>
                  ...
                  <p>
                      ...
                      %>
                      <%=year%> &copy; mykidstale.com All Rights Reserved.<br>
                      <a href="//mykidstale.com/legal">Terms of Use</a> | <a href="//mykidstale.com/legal">Privacy Policy</a>
                  </p>
              </div>--%>
...
<script type="text/javascript">
    ...
    _gaq.push(['_setDomainName', '.mykidstale.com']);
