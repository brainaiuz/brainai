...
<head>
    ...
    <link rel="shortcut icon" href="/customisation/akfa/images/favicon.ico" type="image/x-icon"/>
    ...
    <div class="pg_landing__container">
        <figure class="pg_landing__header" style="margin-top: 50px;">
            <div class="pg_landing__logo">
                <a href="#">
                    <img src="/customisation/akfa/images/logo.svg" alt="logo" style="width: 250px !important;"/>
                </a>
            </div>
        </figure>
