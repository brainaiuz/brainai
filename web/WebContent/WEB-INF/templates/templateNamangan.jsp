...
<head>
    ...
    <link rel="shortcut icon" href="/customisation/citynet/images/favicon.ico" type="image/x-icon"/>
    ...
    <div class="pg_landing__container">
        <figure class="pg_landing__header" style="margin-top: 50px;">
            <div class="pg_landing__logo">
                <a href="#">
                    <img src="/customisation/citynet/images/logo2.png" alt="logo" style="width: 230px !important;"/>
                </a>
            </div>
        </figure>
