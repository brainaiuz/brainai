...
<head>
    ...
    <link rel="stylesheet" href="/mainStyles/new-ui/login/css/templateHotel.css?v=<%=SpringPropertiesUtil.getProperty("cssVersion")%>"/>
</head>
<body>
    ...
    <div class="login-section">
        <div class="login-container">
            <div class="login-header">
                <h1>Manage multiple businesses <span class="noWrapp">from a single platform.</span></h1>
            </div>

            <form class="login-form" action="/mainLogin" method="post">
                <div class="form-group">
                    <label for="login">Your email</label>
                    <div class="control-group">
                        <input type="text" id="login" name="USER_NAME" class="form-control" placeholder="Enter your email">
                    </div>
                </div>
                ...
                <div class="form-group forgot-pass">
                    <a href="/auth/forgotPassword.html">Forgot your password?</a>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        const passwordToggle = document.querySelector('.password__view');
        ...
        if (passwordToggle && passwordInput) {
            passwordToggle.addEventListener('click', () => {
                ...
                passwordToggle.querySelector('span').textContent = isPassword ? 'Show' : 'Hide';
            });
        }
    });
</script>
