...
<head>
    ...
    <link rel="stylesheet" href="/customisation/activira/appFrame.css"/>
    <link rel="stylesheet" href="/customisation/activira/master.css"/>
    <link href="/customisation/activira/images/favicon.ico" rel="shortcut icon">
    <!--[if lt IE 9]>
    ...
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="/customisation/activira/fix-ie.css"/>
    <![endif]-->

    <script type="text/javascript" src="/customisation/activira/scripts/jquery.js"></script>
    <script type="text/javascript" src="/customisation/activira/scripts/common.js"></script>

    <SCRIPT type=text/javascript src="/customisation/activira/jquery.placeholder.min.js"></SCRIPT>
...
<header>
    <div class="ZoneIn">
        ...
        <!-- begin logo site -->
        <a href="" id="logo">
            <img style="height:82px;margin-left: -28px;" src="/customisation/activira/images/logo.png">
        </a>
        ...
        <hgroup>
            ...
            <div class="sitePhone">
                <em>Need Help?</em>
                <span>+966 (56) 777-7663 Ext: 810</span>
            </div>
    ...
    <div id="content" class="full-main">
        ...
        <footer>
            ...
            <div class="footCaption">
                <a href="//activira.com/" id="foot-logo">
                    <img alt="Logo" src="/customisation/activira/images/taswar.png">
                </a>
                <span>Powered by "Tasawr Interactive".</span>
                ...
                <p>
                    ...
                    %>
                    <%=year%> &copy; activira.com All Rights Reserved.<br>
                    <a href="//activira.com/legal">Terms of Use</a> | <a href="//activira.com/legal">Privacy
                    Policy</a>
                </p>
            </div>
