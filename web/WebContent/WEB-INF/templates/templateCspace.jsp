...
<head>
    ...
    <link rel="shortcut icon" href="/customisation/cspace/images/cspace_favicon.svg" type="image/x-icon"/>
...
<div class="pg_landing">
    <div class="pg_landing__container">
        <figure class="pg_landing__header" style="margin-top: 50px; text-align: center;">
            <a href="#">
                <img src="/customisation/cspace/images/cspace_logo.png"
                     alt="logo"
        ...
        <figcaption style="text-align: center; font-size: 27px; font-weight: normal; margin-top: 20px;">
                        ...
                        <dl>
                            ...
                            <dd>
                                                        <span class="pg_landing__start-btn">
                                                           <a id="forgot"
                                                              href="/forgot/forgotPassword.html"> <fmt:message
