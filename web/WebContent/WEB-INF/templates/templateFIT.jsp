...
<head>
    ...
    <link rel="stylesheet" href="/customisation/financial+it/style.css"/>
    <link rel="stylesheet" href="/customisation/financial+it/appFrame.css"/>
    <link rel="stylesheet" href="/customisation/financial+it/master.css"/>
    <link href="/customisation/financial+it/images/favicon.ico" rel="shortcut icon">
    <!--[if lt IE 9]>
    ...
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="/customisation/financial+it/fix-ie.css"/>
    <![endif]-->

    <script type="text/javascript" src="/customisation/financial+it/scripts/jquery.js"></script>
    <script type="text/javascript" src="/customisation/financial+it/scripts/common.js"></script>

    <SCRIPT type=text/javascript src="/customisation/financial+it/scripts/jquery.placeholder.min.js"></SCRIPT>
...
<header>
    <div class="ZoneIn">
        ...
        <!-- begin logo site -->
        <a href="//www.financialit.net" id="logo">
            <img src="/customisation/financial+it/images/logo.png">
        </a>
        ...
        <nav class="menu-main-menu-container">
            <ul class="menu" id="menu-main-menu">
                ...
                <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-2170"
                    id="menu-item-2170">
                    <a href="//financialit.net/about/">About</a>
                    <%--<ul class="sub-menu">--%>
                        <%--<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-590"--%>
                            <%--id="menu-item-590"><a href="//financialit.net/about-kpi-com/">About financialit.net</a></li>--%>
                        <%--<li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-643"--%>
                            <%--id="menu-item-643"><a href="//financialit.net/category/press-release/">Press Release</a></li>--%>
                        <%--<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-683"--%>
                            <%--id="menu-item-683"><a href="//financialit.net/customers/">Customers</a></li>--%>
                        <%--<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-689"--%>
                            <%--id="menu-item-689"><a href="//financialit.net/legal/">Legal</a></li>--%>
    ...
    <div id="content" class="full-main">
        ...
        <footer>
            ...
            <div class="footCaption">
                <a href="//financialit.net/" id="foot-logo">
                    <img alt="Logo" src="/customisation/financial+it/images/logo.png">
                </a>
                ...
                <p>
                    ...
                    %>
                    <%=year%> &copy; Financial IT All Rights Reserved.<br>
                    <a href="//financialit.net/term-of-use">Terms of Use</a> | <a href="//financialit.net/privacy-policy">Privacy Policy</a>
                </p>
            </div>
...
<script type="text/javascript">
    ...
    _gaq.push(['_setDomainName', '.financialit.net']);
