...
<head>
    ...
    <link rel="shortcut icon" href="/customisation/artel/images/favicon.ico" type="image/x-icon"/>
    ...
    <div class="pg_landing__container">
        <figure class="pg_landing__header" style="margin-top: 50px;">
            <div class="pg_landing__logo">
                <a href="#">
                    <img src="/customisation/artel/images/logo.png" alt="logo" style="width: 250px !important;"/>
                </a>
            </div>
        </figure>
