...
<head>
    ...
    <link rel="shortcut icon" href="/customisation/gtl/images/gtl.png" type="image/x-icon"/>
    ...
    <div class="pg_landing__container">
        <figure class="pg_landing__header" style="margin-top: 50px;">
            <div class="pg_landing__logo">
                <a href="#">
                    <img src="/customisation/gtl/images/gtl.png" alt="logo" style="width: 170px !important;"/>
                </a>
            </div>
        </figure>
