...
<head>
    ...
    <link rel="stylesheet" href="/customisation/enfion/style.css"/>
    <link rel="stylesheet" href="/customisation/enfion/appFrame.css"/>
    <link rel="stylesheet" href="/customisation/enfion/master.css"/>
    <link href="customisation/enfion/images/favicon.ico" rel="shortcut icon">
    <!--[if lt IE 9]>
    ...
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="/customisation/enfion/fix-ie.css"/>
    <![endif]-->

    <script type="text/javascript" src="/customisation/enfion/scripts/jquery.js"></script>
    <script type="text/javascript" src="/customisation/enfion/scripts/common.js"></script>
...
<header>
    <div class="ZoneIn">
        ...
        <!-- begin logo site -->
        <a href="//enfion.com" id="logo">
            <img src="/customisation/enfion/images/logo.png">
        </a>
        ...
        <hgroup>
            ...
            <div class="sitePhone">
                <em>Need Help?</em>
                <span>+62 21 3309 7200</span>
                <span>+62 31 77888577</span>
            </div>
        ...
        <footer>
            ...
            <ul class="menu" id="menu-stay-connected">
                <li class="markEmail socialBookMark menu-item menu-item-type-custom menu-item-object-custom menu-item-18"
                    id="menu-item-18">
                    <a href="mailto:support@enfion.com" target="_blank">Email</a>
                </li>
            ...
            <div class="footCaption">
                <a href="//enfion.com/" id="foot-logo">
                    <img alt="Logo" src="/customisation/enfion/images/foot_logo.png">
                </a>
                <span>Powered by EIKON Technology. PT </span>
                ...
                <p>
                    ...
                    %>
                    <%=year%> &copy; enfion.com All Rights Reserved.<br>
                    <a href="//enfion.com/legal">Terms of Use</a> | <a href="//enfion.com/legal">Privacy Policy</a>
                </p>
            </div>
