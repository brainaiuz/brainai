...
<head>
    ...
    <link rel="stylesheet" href="/customisation/idaA+hr+cloud/style.css"/>
    <link rel="stylesheet" href="/customisation/idaA+hr+cloud/appFrame.css"/>
    <link rel="stylesheet" href="/customisation/idaA+hr+cloud/master.css"/>
    <link href="/customisation/idaA+hr+cloud/images/favicon.ico" rel="shortcut icon">
    <!--[if lt IE 9]>
    ...
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="/customisation/idaA+hr+cloud/fix-ie.css"/>
    <![endif]-->

    <script type="text/javascript" src="/customisation/idaA+hr+cloud/scripts/jquery.js"></script>
    <script type="text/javascript" src="/customisation/idaA+hr+cloud/scripts/common.js"></script>

    <SCRIPT type=text/javascript src="/customisation/idaA+hr+cloud/jquery.placeholder.min.js"></SCRIPT>
...
<header>
    <div class="ZoneIn">
        ...
        <!-- begin logo site -->
        <a href="//www.idaaerpservices.com" id="logo">
            <img src="/customisation/idaA+hr+cloud/images/logo.png">
        </a>
        ...
        <hgroup>
            ...
            <div class="langBar">
                ...
                <%--<li><a href="//idaaerpservices.com/o-que-o-workforcetrack-representa-e-por-que-precisamos-dele"--%>
                <%--class="langPo">Portuguese</a></li>--%>
                <%--<li><a href="http://www.idaaerpservices.com.ru/" class="langRU">Russian</a></li>--%>
                <%--<li><a href="//idaaerpservices.com/kpi-com-nedir-ve-neden-ihtiyacim-var" class="langTU">Turkey</a></li>--%>
                <%--</ul>--%>
            </div>

            <div class="sitePhone">
                <em>Need Help?</em>
                <span>+971506536006</span>
            </div>
        ...
        <nav class="menu-main-menu-container">
            ...
            <%--id="menu-item-2170">--%>
            <%--<a href="//idaaerpservices.com/about/">About</a>--%>
            <%--<ul class="sub-menu">--%>
            <%--<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-590"--%>
            <%--id="menu-item-590"><a href="//idaaerpservices.com/about-kpi-com/">About idaaerpservices.com</a></li>--%>
            <%--<li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-643"--%>
            <%--id="menu-item-643"><a href="//idaaerpservices.com/category/press-release/">Press Release</a></li>--%>
            <%--<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-683"--%>
            <%--id="menu-item-683"><a href="//idaaerpservices.com/customers/">Customers</a></li>--%>
            <%--<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-689"--%>
            <%--id="menu-item-689"><a href="//idaaerpservices.com/legal/">Legal</a></li>--%>
            ...
            <%--id="menu-item-559"><a href="//idaaerpservices.com/careers/">Careers</a></li>--%>
            <%--<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1750"--%>
            <%--id="menu-item-1750"><a href="http://blog.idaaerpservices.com/">Blog</a></li>--%>
            <%--</ul>--%>
            <%--</li>--%>
            <%--<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-592" id="menu-item-592">--%>
            <%--<a href="//idaaerpservices.com/contact-us/">Contact Us</a>--%>
            <%--</li>--%>
            <%--</ul>--%>
        </nav>
        ...
        <footer>
            ...
            <ul class="menu" id="menu-stay-connected">
                <li class="markEmail socialBookMark menu-item menu-item-type-custom menu-item-object-custom menu-item-18"
                    id="menu-item-18">
                    <a href="mailto:support@idaaerpservices.com" target="_blank">Email</a>
                </li>
            ...
            <div class="footCaption">
                <a href="//idaaerpservices.com/" id="foot-logo">
                    <img alt="Logo" src="/customisation/idaA+hr+cloud/images/image001.png">
                </a>
                <span>Powered by idaaerpservices.com </span>
                ...
                <p>
                    ...
                    %>
                    <%=year%> &copy; idaaerpservices.com All Rights Reserved.<br>
                    <a href="//idaaerpservices.com/legal">Terms of Use</a> | <a href="//idaaerpservices.com/legal">Privacy Policy</a>
                </p>
            </div>
