...
<xsl:stylesheet version="1.1"
        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="simpleA4">
                ...
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <xsl:apply-templates select="projectSummary"/>
                    <xsl:apply-templates select="departmentSummary"/>
                </fo:flow>
    ...
    <xsl:template match="projectSummary">
        <fo:block font-family="arial" font="10pt Helvetica">
            <fo:table border="solid" border-width="thin" margin-left="0pt" margin-right="0pt"
                ...
                <fo:table-column column-number="1" border="solid" border-width="thin" column-width="150pt"/>
                <fo:table-column column-number="2" border="solid" border-width="thin" column-width="150pt"/>
                <fo:table-column column-number="3" border="solid" border-width="thin" column-width="60pt"/>
                <fo:table-column column-number="4" border="solid" border-width="thin" column-width="60pt"/>
                <fo:table-column column-number="5" border="solid" border-width="thin" column-width="60pt"/>
                ...
                <fo:table-body>
                    <fo:table-row background-color="#FFFFFF" color="#365F91">
                        ...
                        <fo:table-cell column-number="3" padding-before="0.1cm" padding-after="0.1cm">
                            <fo:block font-family="arial" font-size="8" font-weight="bold" text-align="center">
                                Load:
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell column-number="4" padding-before="0.1cm" padding-after="0.1cm">
                            <fo:block font-family="arial" font-size="8" font-weight="bold" text-align="center">
                                Actual:
                            </fo:block>
                        </fo:table-cell>
                        <fo:table-cell column-number="5" padding-before="0.1cm" padding-after="0.1cm">
                            <fo:block font-family="arial" font-size="8" font-weight="bold" text-align="center">
                                Planned:
                            </fo:block>
                        </fo:table-cell>
    ...
    <xsl:template match="departmentSummary">
        <fo:block font-family="arial" font="10pt Helvetica">
            <fo:table border="solid" border-width="thin" margin-left="0pt" margin-right="0pt"
       ...
       <fo:table-row color="#365F91">
           ...
           <fo:table-cell column-number="2" padding-before="0.1cm" padding-after="0.1cm">
               <fo:block font-family="arial" font-size="8" font-weight="normal"
                         text-align="center">
                   <xsl:value-of select="manager_leader"/>
               </fo:block>
           </fo:table-cell>
           <fo:table-cell column-number="3" padding-before="0.1cm" padding-after="0.1cm">
               <fo:block font-family="arial" font-size="8" font-weight="normal"
