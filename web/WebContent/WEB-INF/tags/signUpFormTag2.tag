...
<div style="padding:3px;margin:10px 0 10px 0; background: #fcefc8; border:1px solid #edd28a;">
    <img border="0" style="margin:4px;float: left;" alt="Google Account" title="Login using your Google Account"
         src="/i/google.jpg"/>
    <a href="/check?service=${serviceType}" style="font-size:12px; color:#205476">No need to create a new account. You
        may use your
        Google Account to Sign In</a>
</div>
        ...
        <tr>
            <td id="bor">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td colspan="2"><h2>Sign Up Now. 7 days FREE Trial</h2></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <form:input path="adminEmail"
                                        onblur="sendRequest('GET','/signup/freeTrial.html?action=handleAjaxRequest&adminEmail='+this.value,this.value)"/>
                        </td>
                    </tr>
                    <tr>
                        <td/>
                    ...
                    <tr>
                        <td/>
                        <td>
                            <span id="emailValidate" class="error">
                                <form:errors path="adminEmail" cssClass="error" htmlEscape="false"/></span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><label for="countryID">Country:<span>*</span></label></td>
                        <td>
                    ...
                    <tr>
                        <td colspan="2">
                            <form:checkbox path="agreeWithCondition" id="terms"/>&nbsp;<label for="terms"
                                                                                              id="agree">I agree
                            with the <a
                                    href="<%=Constants.DRUPAL_DOMEN%>content/terms-of-use" target="_blank">Terms and
                                Conditions</a></label>&nbsp;
                    ...
                    <tr>
                        <td colspan="2"><p><b>Note:</b> Please be advised that we use your personal
                            information to correspond with you, and to process
                            your requests for our services. We do not sell, trade
                            or rent your personal information to the third parties. </p></td>
                    </tr>
