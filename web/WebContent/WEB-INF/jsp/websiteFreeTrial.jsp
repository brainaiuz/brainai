...
<%--<link href="/i/signup/webFormSignup.css" rel="stylesheet" type="text/css"/>--%>
<link href="/customisation/${productNameLower}/signupAWS.css" rel="stylesheet" type="text/css"/>

<meta name="msvalidate.01" content="358DD608AB06D6ED2E842AF53CAFFB9E"/>

<form:form method="post" commandName="newCompany" cssClass="webform-client-form signUp-form sidebarForm " action="/signup/websiteFreeTrial.html">
    ...
    <div>
        ...
        <input class="form-submit" type="submit" id="edit-submit"
               value='<fmt:message key="signup.getDemoVersion"> </fmt:message> ' onclick="this.form.submit();"/>

        <input type="hidden" name="agreeWithCondition" value="true"/>
        <input type="hidden" name="_agreeWithCondition" value="on"/>
        <input type="hidden" name="companySignedUpFrom" value="SLIDEBAR_SIGNUP_jsp"/> <%--referral--%>
