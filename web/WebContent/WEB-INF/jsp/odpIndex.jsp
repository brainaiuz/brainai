                        ...
                        <div class="loginBox">
                            ...
                            <center>
                                <ul class="useSocialBookMarking">
                                    ...
                                    <li><a href="/sendtolinkedinauthorization" class="mini-icons mini-linkedin" >Linkedin</a></li>
                                    <li>
                                        <div class="fb-login-button" data-max-rows="1" data-label = "Facebook" data-size="large" data-show-faces="false" data-auto-logout-link="false" onlogin="fbRedirect()" data-scope = "basic_info, read_stream, email"></div>
                                    </li>
                                </ul>
                                ...
                                |
                                <a href="/signup/freeSignup.html"><fmt:message key="template.header.createAccount"/> </a>
                            </div>
                        </div>
                        </div>
