...
<tiles:insertDefinition name="frontEndLayoutNew">
    ...
    <tiles:putAttribute name="body">
            ...
            <article class="post-9541 page type-page status-publish hentry" id="post-9541">
                ...
                <div class="row products_review bottomField">
                    ...
                    <div class="col-md-12 main-content page-activation">
                        ...
                        <p>Password should be at least 9 characters long for ordinary user and 14 characters long for Administrator, Director and Accountant.</p>
                        <br>
                        <div class="row">
                            <div class="col-md-5">
                                <form role="form" action='<c:url value="/password/changePassword.html"/>' method="post">
                                    ...
                                    <div class="col-md-offset-4 col-md-8">
                                        <button class="btn btn-default btn-block" type="submit" onclick = "document.getElementById('strength').value=checkPassLengthAndStrength('${roles}', document.getElementById('pass1').value)" ><fmt:message key="existinguser.continue"/></button>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            ...
            function checkPassLengthAndStrength(role, pass) {
                if (pass.length < 9) {
                    return "SHORT";
                }

                if ((role.indexOf("Administrator") || role.indexOf("Accountant") || role.indexOf("Director")) && pass.length < 14) {
                    return "SHORT";
                }
