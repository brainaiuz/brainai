...
<link href="/customisation/${productNameLower}/iframeSignup.css" rel="stylesheet" type="text/css"/>
...
<form:form method="post" commandName="newCompany" cssClass="webform-client-form signUp-form">
    ...
    <div>
        ...
        <div id="edit-promo-code-wrapper" class="form-item odd">
            <label for="edit-promo-code"> <fmt:message key="signup.promutionalCode">:</fmt:message> </label>
        ...
        <input type="hidden" name="companySignedUpFrom" value="WEB_FORM_SIGNUP_jsp"/> <%--referral--%>
