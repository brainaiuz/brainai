...
<head>
  ...
  <script src="js/vendor/modernizr-2.6.2.min.js"></script> -->
    ...
    <title>KMRSI Password Reset</title>
</head>
<body>
<!--[if lt IE 7]>
...
<div id="wrapper" class="page-login">
    ...
    <div id="content">
        <form action="/forgot/forgotPassword.html" class="loginForm-cover" method="post">
            <div class="tabs-nav">
                <strong class="tab">Password Reminder</strong>
            </div>
            <div class="loginForm tabs-content group">
                ...
                <table style="margin-bottom:15px;">
                    <tr>
                        <td style="vertical-align:middle;padding-bottom: 10px;">E-mail address:</td>
                        <td style="vertical-align:middle;">
                            <input type="text" name="email" value="" class="email-style"/>
                        </td>
                        <td style="vertical-align: middle;">
                            <span><input type="submit" value="Send Password" class="btn-submit"
                                         style="width: 130px;margin-top: 0;margin-bottom: 9px;"/></span>
                        </td>
                        <td style="vertical-align:middle;">
                            <h2 class="error" style="margin-left:5px;margin-top:5px;font-size:14px;"> ${message}</h2>
                        </td>
                    </tr>
                </table>
            </div>
