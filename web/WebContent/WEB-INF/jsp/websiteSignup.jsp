    ...
    <div>
        ...
        <c:if test="${fn:containsIgnoreCase(hostName,'1erp.sa')}">
            <div id="edit-submitted-country-wrapper" class="form-item even">
                ...
                <form:select path="countryID" cssClass="form-select" onchange="getStateWithCountryId(this.value)">
            ...
            <div id="edit-submitted-state-wrapper" class="form-item odd">
                <label for="edit-submitted-state"><fmt:message key="signup.province">:</fmt:message>
                </label>

                <form:select path="stateID" id="edit-submitted-state" cssClass="form-select">
                    <form:option value=""> <fmt:message key="signup.pleaseSelect"> </fmt:message> </form:option>
        ...
        <input class="form-submit" type="submit" id="edit-submit"
               value='<fmt:message key="signup.demoVersion"> </fmt:message> ' onclick="this.disabled = true;this.form.submit();"/>
