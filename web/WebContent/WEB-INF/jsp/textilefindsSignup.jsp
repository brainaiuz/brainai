...
<head>
    ...
    <script>
        async function validateAndSubmit(event) {
            ...
            var activeProfile = '<%= (String) request.getAttribute("activeProfile") %>';

            if (activeProfile !== "staging" && activeProfile !== "local") {
...
<div class="pg_landing pg_sign-up">
    <div class="pg_landing__container">
        <figure class="pg_landing__header">
            <img src="/customisation/textilefinds/images/logo.png"
                 alt="logo"
                 style="width: 280px !important; display: block; margin: auto;"/>
            <br>
                ...
                <div class="${not empty errorMessage ? 'cp_login cp_login--error' : 'cp_login'}">
                    ...
                    <div class="cp_login__content">
                        ...
                        <form:form method="post" modelAttribute="newCompany" id="signUpFree" cssClass="cp_login__main">
                            ...
                            <input type="hidden" id="activeProfile" value="${activeProfile}"/>
                            <div class="cp_login__field">
                                <form:input path="adminFName" required="required" id="signUpFree_firstName"
                                            cssClass="${not empty nameHasBindError ? 'cp_login__field-invalid' : ''}"
                                            placeholder="Name"/>
                                <div class="cp_login__field-underline "></div>
                            </div>
                            <div class="cp_login__field">
                                <form:input path="adminEmail" id="signUpFree_email" required="required" type="email"
                                            placeholder="Email"
                                            cssClass="${not empty emailHasBindError ? 'cp_login__field-invalid' : ''}"/>
                            ...
                            <div class="cp_login__field controls-stack">
                                <label class="control control--checkbox">
                                    ...
                                    <span class="control__description" for="agreeWithTerms">
                                        I agree to the
                                        <a href="https://www.kpi.com/company/terms/">Terms of Service</a>
                                        and
                                        <a href="https://www.kpi.com/company/privacy/">Privacy Policy</a>.
                                    </span>
                                </label>
                            </div>
                            ...
                            <div class="cp_login__form-item" id="signUp">
                                <input type="submit" class="cp_login__submit elm_btn--green" value="Sign up"
                        ...
                        <dl>
                            ...
                            <dd>
                                <span class="pg_landing__start-btn">
                                    <a class="btn-login-sign-up" href="/index.html">Login</a>
                                </span>
                            </dd>
                        </dl>
                    </div>
    ...
    function start() {
        gapi.load('auth2', function () {
            auth2 = gapi.auth2.init({
                ...
                // Attach sign-in methods to buttons or form handlers here
            });
        });
    }
</script>
