...
<link href="/customisation/${productNameLower}/webFormSignup.css" rel="stylesheet" type="text/css"/>
    ...
    <div>
        ...
        <div id="edit-promo-code-wrapper" class="form-item odd">
            <label for="edit-promo-code">
                ...
                <%--<input type="text" class="form-text required" value="" id="edit-submitted-company" name="submitted[company]" />--%>
            <%--<form:input path="name" cssClass="form-text required" id="edit-submitted-company"/>--%>
            <input type="input" name="companySignedUpFrom" id="edit-promo-code" class="formsize"/> <%--referral--%>
            <%--<span> <form:errors path="name" cssClass="error"/> </span>--%>

        <%--</div>--%>
        <div class="form-item even" style="border-top: 1px dotted; padding-top: 5px;">
            <label>
                 <span title="This field is required." class="form-required">*</span> <fmt:message key="mandatoryFields"/>
            </label>
