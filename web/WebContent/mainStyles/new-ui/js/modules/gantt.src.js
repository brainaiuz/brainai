...
(function (factory) {
    ...
    _registerModule(_modules, 'parts-gantt/GanttChart.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js']], function (H, U) {
        ...
        H.GanttChart = H.ganttChart = function (renderTo, options, callback) {
            var hasRenderToArg = typeof renderTo === 'string' || renderTo.nodeName, defaultOptions = H.getOptions(), defaultLinkedTo;
            options = arguments[hasRenderToArg ? 1 : 0];
            var seriesOptions = options.series, userOptions = options;
