/**
 * @license Highcharts JS vgantt (2018-10-02)
 * Gantt series
 *
...
(function (factory) {
		...
		seriesType('xrange', 'column', {
		    ...
		    dataLabels: {
		        ...
		        formatter: function () {
					 ...
					 *	is used to Round to at most 2 decimal places
					 */
	...
	(function (H) {
		...
		*/
		 ...
		 *                                         loaded.
		 */
		H.GanttChart = H.ganttChart = function (a, b, c) {
